# -*- coding: utf-8 -*-
# =============================================================================
# Script_BESS_Simulacao_004_bus_0700_duas_simulacoes_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 004 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 004 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 004 segmentos_pass1_sem_hvac_int_ano_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 004 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 004 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 004 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 004 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 004 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_4.csv
# Remove:
...
#   Simulacao 004 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 004 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim4.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM4 - ANO 2047)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM4: curva GERAL com BESS para o ano 2047
# Saida:
#   Simulacao 004 segmentos_ano_2047/01_Integralizacao_Mensal_SIM4_2047.csv
# =============================================================================
...
# %% Celula 011 - SIMULACAO 004: tabela de custos (SIM4 - ANO 2047)
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos_ano_2047/01_Integralizacao_Mensal_SIM4_2047.csv
#
# Saida:
#   Simulacao 004 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM4_2047.csv
# =============================================================================
...
# - DCFP = 5000 * 1,11 = 5550 kW.
# - DCP sem BESS = 3000 * 1,11 = 3330 kW.
# - DCP com BESS = 3330 - 673 = 2657 kW.
