# -*- coding: utf-8 -*-
# =============================================================================
# 014_Script_BESS_Simulacao_013_5bus_0700_2220_2380_1250_1630_duas_simulacoes_ano_2028_2034_2037_2039_2041.py
#
# Regras deste script:
...
#     Simulacao 013 segmentos_pass1_sem_hvac_int_ano_2041
#   PASSO 2 (simulacao completa final):
#     Simulacao 013 segmentos_ano_2041
# =============================================================================
...
TARGETS = {
    ...
    "FORA_PONTA": {"kWtarget": 9999, "kWtargetLow": 5400},
}

DIR_PASS1 = WORK_DIR / "Simulacao 013 segmentos_pass1_sem_hvac_int_ano_2041"
...
def build_circuit_pass1(
    ...
    dss.text('Redirect "UFSM_cargas_medidas_ano_2041.dss"')
    dss.text('Redirect "UFSM_cargas_especiais_ano_2041.dss"')
    dss.text('Redirect "UFSM_cargas_estimadas_com_residuo_ano_2041.dss"')
    ...
    dss.text(
        ...
        "kWrated=753 kWhrated=2825 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
        "%reserve=2.5 dispmode=external"
    )
    dss.text(
        "New Storage.BESSM3 phases=3 bus1=B033 kv=0.38 "
        "kWrated=773 kWhrated=2900 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
        "%reserve=2.5 dispmode=external"
    )
    dss.text(
...
DIR_PASS2 = WORK_DIR / "Simulacao 013 segmentos_ano_2041"
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2041/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 013 segmentos_ano_2041/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2041/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 013 segmentos_ano_2041/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 013 segmentos_ano_2041/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 013 segmentos_ano_2041/Curva_de_Carga_<KEY>_sim_13.csv
# Remove:
...
#   Simulacao 013 segmentos_ano_2041/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 013 segmentos_ano_2041/Resumo_EnergyMeter_Geral_Sim13.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM13 - ANO 2041, 5 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM13: curva GERAL com 5 BESS para o ano 2041
# Saida:
#   Simulacao 013 segmentos_ano_2041/01_Integralizacao_Mensal_SIM13_2041.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 5 BESS do ano 2041 por mes e posto.
# =============================================================================
...
SIM13_DIR = WORK_DIR / f"Simulacao 013 segmentos_ano_{ANO_ANALISE}"
...
# %% Celula 011 - SIMULACAO 013: tabela de custos (SIM13 - ANO 2041, 5 BESS)
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2041/01_Integralizacao_Mensal_SIM13_2041.csv
#
# Saida:
#   Simulacao 013 segmentos_ano_2041/Tabela_demanda_consumo_por_posto_SIM13_2041.csv
#
# Demandas contratadas do ano 2041:
#   DCFP = 5000 kW * (1 + 16 * 0,5%) = 5400 kW
#   DCP sem BESS = 3000 kW * (1 + 16 * 0,5%) = 3240 kW
#   DCP com 5 BESS = max(0, 3240 - 3826) = 0 kW
#
# Observacao:
...
DCP_SEM_BESS = 3240.0                                            # 3240 kW em 2041
DCFP_COM_BESS = 5400.0                                          # 5400 kW em 2041
BESS1_P_KW = 713.0
BESS2_P_KW = 753.0
BESS3_P_KW = 773.0
BESS4_P_KW = 787.0
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - P_BESS_TOTAL_KW)             # 0 kW em 2041
