# -*- coding: utf-8 -*-
# =============================================================================
# 014_Script_BESS_Simulacao_013_5bus_0700_2220_2380_1250_1630_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 013 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 013 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 013 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 013 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 013 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 013 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 013 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 013 segmentos/Curva_de_Carga_<KEY>_sim_13.csv
# Remove:
...
#   Simulacao 013 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 013 segmentos/Resumo_EnergyMeter_Geral_Sim13.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM13)
# =============================================================================
# Entradas:
...
#   SIM13: Simulacao 013 segmentos/Curva_de_Carga_GERAL_sim_13.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 013 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM13_2025.csv
# =============================================================================
...
SIM13_DIR = WORK_DIR / "Simulacao 013 segmentos"
...
OUT_FP = SIM13_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM13_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM13_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM13", sim13, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df13 = meta.merge(sim13, on="k", how="left").rename(columns={"P_3f_S": "P_SIM13", "Q_3f_S": "Q_SIM13"})
...
agg = agg2.merge(agg13, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 013: Tabela de custos (SIM2 vs SIM13 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM13_2025.csv
#
# Saidas (todas em Simulacao 013 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM13_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM13_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM13_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM13_2025.csv"
OUT_SIM2 = SIM13_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM13 = SIM13_DIR / "Tabela_demanda_consumo_por_posto_SIM13_2025.csv"
OUT_CMP = SIM13_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM13_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM13 = {"DCFP": 5000.0, "DCP":   0.0}  # 3000 - 4*000
...
tab13 = tabela_custos(df, "SIM13", DCFP=CONTR_SIM13["DCFP"], DCP=CONTR_SIM13["DCP"])
...
print("DONE. Saved (Simulacao 013 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM13)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM13: DCFP=5000, DCP=0")
print("\nResumo anual:")
print(cmp.tail(1))
