# -*- coding: utf-8 -*-
# =============================================================================
# 015_Script_BESS_Simulacao_014_6bus_0700_2220_2380_1250_1630_1950_duas_simulacoes_2047.py
#
# Regras deste script:
...
#     Simulacao 014 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 014 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 014 segmentos_pass1_sem_hvac_int_ano_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 014 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 014 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 014 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 014 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 014 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_14.csv
# Remove:
...
#   Simulacao 014 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 014 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim14.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM14 - ANO 2047, 6 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM14: curva GERAL com 6 BESS para o ano 2047
# Saida:
#   Simulacao 014 segmentos_ano_2047/01_Integralizacao_Mensal_SIM14_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 6 BESS do ano 2047 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 014: tabela de custos (SIM14 - ANO 2047, 6 BESS)
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos_ano_2047/01_Integralizacao_Mensal_SIM14_2047.csv
#
# Saida:
#   Simulacao 014 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM14_2047.csv
#
...
# - A demanda contratada de ponta com 6 BESS considera abatimento de 6 x 673 kW,
...
DCP_SEM_BESS = DCP_BASE_2025 * FATOR_CRESCIMENTO       # 3330 kW
DCFP_COM_BESS = DCFP_BASE_2025 * FATOR_CRESCIMENTO     # 5550 kW
