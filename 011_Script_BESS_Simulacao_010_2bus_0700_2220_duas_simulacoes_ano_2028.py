# -*- coding: utf-8 -*-
# =============================================================================
# 011_Script_BESS_Simulacao_010_2bus_0700_2220_duas_simulacoes_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 010 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 010 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 010 segmentos_pass1_sem_hvac_int_ano_2028"
...
DIR_PASS2 = WORK_DIR / "Simulacao 010 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 010 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 010 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 010 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 010 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_10.csv
# Remove:
...
#   Simulacao 010 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 010 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim10.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM10 - ANO 2028, 2 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM10: curva GERAL com 2 BESS para o ano 2028
# Saida:
#   Simulacao 010 segmentos_ano_2028/01_Integralizacao_Mensal_SIM10_2028.csv
# =============================================================================
...
# %% Celula 011 - SIMULACAO 010: tabela de custos (SIM10 - ANO 2028, 2 BESS)
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2028/01_Integralizacao_Mensal_SIM10_2028.csv
#
# Saida:
#   Simulacao 010 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM10_2028.csv
# =============================================================================
...
# - A demanda contratada de ponta com 2 BESS considera abatimento de 2 x 800 kW.
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - NUM_BESS * BESS_P_KW) # 1445 kW em 2028
