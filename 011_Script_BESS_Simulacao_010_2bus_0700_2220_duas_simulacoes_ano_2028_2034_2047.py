# -*- coding: utf-8 -*-
# =============================================================================
# 011_Script_BESS_Simulacao_010_2bus_0700_2220_duas_simulacoes_ano_2028_2034_2047.py
#
# Regras deste script:
...
#     Simulacao 010 segmentos_pass1_sem_hvac_int_ano_2034_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 010 segmentos_ano_2034_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 010 segmentos_pass1_sem_hvac_int_ano_2034_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 010 segmentos_ano_2034_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2034_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 010 segmentos_ano_2034_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2034_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 010 segmentos_ano_2034_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 010 segmentos_ano_2034_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 010 segmentos_ano_2034_2047/Curva_de_Carga_<KEY>_sim_10.csv
# Remove:
...
#   Simulacao 010 segmentos_ano_2034_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 010 segmentos_ano_2034_2047/Resumo_EnergyMeter_Geral_Sim10.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM10 - ANO 2047, 2 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM10: curva GERAL com 2 BESS para o ano 2047
# Saida:
#   Simulacao 010 segmentos_ano_2034_2047/01_Integralizacao_Mensal_SIM10_2047.csv
# =============================================================================
...
SIM10_DIR = WORK_DIR / "Simulacao 010 segmentos_ano_2034_2047"
...
# %% Celula 011 - SIMULACAO 010: tabela de custos (SIM10 - ANO 2047, 2 BESS)
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos_ano_2034_2047/01_Integralizacao_Mensal_SIM10_2047.csv
#
# Saida:
#   Simulacao 010 segmentos_ano_2034_2047/Tabela_demanda_consumo_por_posto_SIM10_2047.csv
# =============================================================================
...
# - Em 2047 aplica-se crescimento acumulado de 11% (22 anos desde 2025).
# - BESS1 instalado no inicio do horizonte, com potencia remanescente de 673 kW em 2047.
# - BESS2 instalado em 2034, com potencia remanescente de 713 kW em 2047.
# - Demanda de ponta com BESS = 3330 - (673 + 713) = 1944 kW.
DCP_BASE_2025 = 3000.0
DCFP_BASE_2025 = 5000.0
CRESC_LINEAR_ANUAL = 0.005
BESS1_P_KW_2047 = 673.0
BESS2_P_KW_2047 = 713.0
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - (BESS1_P_KW_2047 + BESS2_P_KW_2047))  # 1944 kW em 2047
...
print("DONE. Saved (Simulacao 010 segmentos_ano_2034_2047):")
print(" -", OUT_SIM10)
