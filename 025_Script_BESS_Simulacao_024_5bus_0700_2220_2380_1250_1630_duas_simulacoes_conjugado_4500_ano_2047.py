# -*- coding: utf-8 -*-
# =============================================================================
# 025_Script_BESS_Simulacao_024_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_4500_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 024 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=3367 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 024 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 024 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 024 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_24.csv
# Remove:
...
#   Simulacao 024 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 024 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim24.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM24 - ANO 2047, 5 BESS degradados)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM24: curva GERAL com 5 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 024 segmentos_ano_2047/01_Integralizacao_Mensal_SIM24_2047.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 024: tabela de custos (SIM24 - ANO 2047, 5 BESS degradados)
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2047/01_Integralizacao_Mensal_SIM24_2047.csv
#
# Saida:
#   Simulacao 024 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM24_2047.csv
#
...
#
# Banco de energia:
#   5 BESS de 1 MW / 4,0 MWh instalados em 2028.
#   Operacao nova a 80% da potencia nominal: 800 kW por banco.
#   Potencia operacional degradada adotada em 2047 = 673 kW por banco.
#   Energia degradada adotada em 2047 = 3367 kWh por banco.
...
# - Cada banco possui 1 MW / 4,0 MWh nominal.
...
# - Em 2047, a energia degradada adotada e 3367 kWh por banco.
...
BESS_E_NOMINAL_UNITARIA_KWH = 4000.0
BESS_E_UNITARIA_KWH = 3367.0
BESS_RESERVA_PONTA_PCT = 75.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW                 # 3365 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH               # 16835 kWh
...
print("DONE. Saved (Simulacao 024 - 5 BESS - 2047 - conjugado 4500):")
print(" -", OUT_SIM24)
