# -*- coding: utf-8 -*-
# =============================================================================
# 017_Script_BESS_Simulacao_016_2bus_0700_2220_duas_simulacoes_conjugado_5000_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 016 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 016 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 016 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=3156 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 016 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 016 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 016 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 016 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 016 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_16.csv
# Remove:
...
#   Simulacao 016 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 016 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim16.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM16 - ANO 2047, 2 BESS 673 kW / 3156 kWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM16: curva GERAL com 2 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 016 segmentos_ano_2047/01_Integralizacao_Mensal_SIM16_2047.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 016: tabela de custos (SIM16 - ANO 2047, 2 BESS 673 kW / 3156 kWh cada)
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2047/01_Integralizacao_Mensal_SIM16_2047.csv
#
# Saida:
#   Simulacao 016 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM16_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP = 5000 kW * (1 + 22 * 0,5%) = 5550 kW
#   DCP sem BESS = 3000 kW * (1 + 22 * 0,5%) = 3330 kW
#   DCP com 2 BESS = 3330 - 1346 = 1984 kW
#
# Observacao:
...
# - Os 2 BESS foram instalados em 2028 e, em 2047, operam com potencia remanescente total de 1346 kW.
# - Cada banco considerado possui 673 kW / 3156 kWh em 2047; o conjunto totaliza 1346 kW / 6312 kWh.
...
BESS_E_UNITARIA_KWH = 3156.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 1346 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 6312 kWh

# Separacao operacional da energia:
# - reserva de 80% da energia para load-shift no horario de ponta;
# - saldo de 20% disponivel para peak-shave fora-ponta.
BESS_RESERVA_PONTA_PCT = 80.0
BESS_E_RESERVA_PONTA_KWH = BESS_E_TOTAL_KWH * BESS_RESERVA_PONTA_PCT / 100.0  # 5049,6 kWh
BESS_E_DISPONIVEL_FP_KWH = BESS_E_TOTAL_KWH - BESS_E_RESERVA_PONTA_KWH        # 1262,4 kWh
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)       # 1984 kW em 2047
...
print("DONE. Saved (Simulacao 016 - 2 BESS - 2047 - conjugado):")
print(" -", OUT_SIM16)
...
print(f" - Reserva para ponta = {BESS_RESERVA_PONTA_PCT:.1f}%")
print(f" - Energia reservada para ponta = {BESS_E_RESERVA_PONTA_KWH:.1f} kWh")
print(f" - Energia disponivel para peak-shave fora-ponta = {BESS_E_DISPONIVEL_FP_KWH:.1f} kWh")
print("\nResumo anual:")
