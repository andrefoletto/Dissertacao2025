# -*- coding: utf-8 -*-
# =============================================================================
# 023_Script_BESS_Simulacao_022_3bus_0700_2220_2380_duas_simulacoes_conjugado_4500_ano_2028_2031.py
#
# Regras deste script:
...
#     Simulacao 022 segmentos_pass1_sem_hvac_int_ano_2031
#   PASSO 2 (simulacao completa final):
#     Simulacao 022 segmentos_ano_2031
# =============================================================================
...
TARGETS = {
    ...
    "FORA_PONTA": {"kWtarget": 4635, "kWtargetLow": 3605},
}
...
DIR_PASS1 = WORK_DIR / "Simulacao 022 segmentos_pass1_sem_hvac_int_ano_2031"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=780 kWhrated=5362.5 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
#     SOC_15min_BESS_SIM22_2031.csv          (SOC dos tres bancos a cada 15 min)
#
# Requisitos:
...
BESS1_E_2031_KWH = 5362.5
BESS2_E_2031_KWH = 5362.5
BESS3_E_2031_KWH = 3000.0
BESS_TOTAL_E_2031_KWH = BESS1_E_2031_KWH + BESS2_E_2031_KWH + BESS3_E_2031_KWH
...
DIR_PASS2 = WORK_DIR / "Simulacao 022 segmentos_ano_2031"
...
if LIMPAR_SAIDAS_ANTERIORES_PASS2:
    padroes_limpeza = [
        ...
        "SOC_por_segmento.csv",
        "SOC_15min_BESS_SIM22_2031.csv",
        "01_Integralizacao_Mensal_SIM22_2031.csv",
        "Tabela_demanda_consumo_por_posto_SIM22_2031.csv",
    ]
    removidos = 0
...
soc_15min_fp = DIR_PASS2 / "SOC_15min_BESS_SIM22_2031.csv"
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2031/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 022 segmentos_ano_2031/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2031/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 022 segmentos_ano_2031/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 022 segmentos_ano_2031/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 022 segmentos_ano_2031/Curva_de_Carga_<KEY>_sim_22.csv
# Remove:
...
#   Simulacao 022 segmentos_ano_2031/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 022 segmentos_ano_2031/Resumo_EnergyMeter_Geral_Sim22.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM22 - ANO 2031, BESS modular autofinanciado)
# =============================================================================
# Entradas:
...
#          para o ano 2031.
# Saida:
#   Simulacao 022 segmentos_ano_2031/01_Integralizacao_Mensal_SIM22_2031.csv
#
# Observacao:
...
#            degradado em 2031 por fator 0,975 para 780 kW / 5362,5 kWh.
...
#     Alvo fora-ponta = 4635 kW; permissao de recarga fora-ponta = 3605 kW.
...
SIM22_DIR = WORK_DIR / f"Simulacao 022 segmentos_ano_{ANO_ANALISE}"
...
# %% Celula 011 - SIMULACAO 022: tabela de custos (SIM22 - ANO 2031, BESS conjugado 4500)
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2031/01_Integralizacao_Mensal_SIM22_2031.csv
#
# Saida:
#   Simulacao 022 segmentos_ano_2031/Tabela_demanda_consumo_por_posto_SIM22_2031.csv
#
# Demandas contratadas do ano 2031:
#   DCFP contratada com BESS = 4635 kW
#   Alvo operacional fora-ponta do despacho = 4500 * 1,03 = 4635 kW
#   Permissao para recarga fora-ponta = 3500 * 1,03 = 3605 kW
#   DCP sem BESS = 3000 * 1,03 = 3090 kW
#   DCP com BESS = 3090 - (780 + 780 + 800) = 730 kW
#
...
#     Em 2031: fator 0,975 -> 780 kW / 5362,5 kWh.
...
# -------------------------
# Fora-ponta: alvo operacional 4500 * 1,03 = 4635 kW; demanda contratada FP = 4635 kW
# Ponta sem BESS: 3000 * 1,03 = 3090 kW
# Ponta com BESS: 3090 - (780 + 780 + 800) = 730 kW
DCP_SEM_BESS = 3090.0
DCFP_COM_BESS = 4635.0
...
BESS1_FATOR_DEGRADACAO_2031 = 0.975
BESS1_P_2031_KW = round(BESS1_P_OPERACIONAL_2028_KW * BESS1_FATOR_DEGRADACAO_2031)
...
BESS2_FATOR_DEGRADACAO_2031 = 0.975
BESS2_P_2031_KW = round(BESS2_P_OPERACIONAL_2028_KW * BESS2_FATOR_DEGRADACAO_2031)
...
BESS_P_TOTAL_KW = BESS1_P_2031_KW + BESS2_P_2031_KW + BESS3_P_OPERACIONAL_2031_KW
BESS_E_TOTAL_KWH = BESS1_E_2031_KWH + BESS2_E_2031_KWH + BESS3_E_2031_KWH
...
BESS_E_RESERVA_PONTA_KWH = BESS1_E_RESERVA_PONTA_2031_KWH + BESS2_E_RESERVA_PONTA_2031_KWH + BESS3_E_RESERVA_PONTA_2031_KWH
BESS_E_DISPONIVEL_FP_KWH = (BESS1_E_2031_KWH - BESS1_E_RESERVA_PONTA_2031_KWH) + (BESS2_E_2031_KWH - BESS2_E_RESERVA_PONTA_2031_KWH)
...
print("DONE. Saved (Simulacao 022 - BESS conjugado 4635 FP - 2031):")
print(" -", OUT_SIM22)
...
print(f" - Potencia BESS3 2031 = {BESS3_P_OPERACIONAL_2031_KW:.0f} kW")
...
print(f" - Excedente degradado por BESS1/BESS2 para fora-ponta = {BESS1_E_EXCEDENTE_FP_2031_KWH:.0f} kWh")
