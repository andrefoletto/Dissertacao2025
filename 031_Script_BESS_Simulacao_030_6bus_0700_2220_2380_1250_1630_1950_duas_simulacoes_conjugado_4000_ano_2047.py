# -*- coding: utf-8 -*-
# =============================================================================
# 031_Script_BESS_Simulacao_030_6bus_0700_2220_2380_1250_1630_1950_duas_simulacoes_conjugado_4000_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 030 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 030 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 030 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=4208 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 030 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 030 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 030 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 030 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 030 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 030 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 030 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_30.csv
# Remove:
...
#   Simulacao 030 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 030 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim30.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM30 - ANO 2047, 6 BESS degradados, base 30 MWh)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM30: curva GERAL com 6 BESS degradados em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 030 segmentos_ano_2047/01_Integralizacao_Mensal_SIM30_2047.csv
#
# Observacao:
...
#   O despacho foi gerado com corte fora-ponta em 4440 kW e permissao de recarga em 3885 kW.
...
# %% Celula 011 - SIMULACAO 030: tabela de custos (SIM30 - ANO 2047, 6 BESS degradados, base 30 MWh)
# =============================================================================
# Entrada:
#   Simulacao 030 segmentos_ano_2047/01_Integralizacao_Mensal_SIM30_2047.csv
#
# Saida:
#   Simulacao 030 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM30_2047.csv
#
...
#
# Banco de energia:
#   6 BESS de 1 MW / 5,000 MWh instalados em 2028 e degradados em 2047.
#   Potencia operacional por banco degradado = 673 kW.
#   Energia nominal total em 2028 = 30000 kWh = 6 x (3000 + 2000) kWh.
#   Energia degradada por banco = 4208 kWh.
#   Energia degradada total = 25248 kWh.
#   Reserva de ponta = 60,0%.
#   Corte fora-ponta = 4440 kW.
#   Permissao de recarga fora-ponta = 3885 kW.
...
# -------------------------
# Premissas:
# - 2047 e o ano final da analise.
# - Os 6 BESS foram instalados em 2028 e estao degradados em 2047.
# - Cada banco possui 1 MW / 5,000 MWh nominal.
# - Em 2047, cada banco opera com 673 kW e 4208 kWh degradados.
# - A demanda contratada fora-ponta foi reduzida de forma mais agressiva para 4440 kW.
# - A permissao de recarga fora-ponta foi ajustada para 3885 kW.
NUM_BESS = 6
...
BESS_E_NOMINAL_UNITARIA_KWH = 5000.0
BESS_E_UNITARIA_KWH = 4208.0
BESS_RESERVA_PONTA_PCT = 60.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW                 # 4038 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH               # 25248 kWh
...
print("DONE. Saved (Simulacao 030 - 6 BESS - 2047 - corte 4440 / recarga 3885):")
print(" -", OUT_SIM30)
