# -*- coding: utf-8 -*-
# =============================================================================
# Script_BESS_Simulacao_004_bus_0700_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 004 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 004 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 004 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 004 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 004 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 004 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 004 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 004 segmentos/Curva_de_Carga_<KEY>_sim_4.csv
# Remove:
...
#   Simulacao 004 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 004 segmentos/Resumo_EnergyMeter_Geral_Sim4.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM4)
# =============================================================================
# Entradas:
...
#   SIM4: Simulacao 004 segmentos/Curva_de_Carga_GERAL_sim_4.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 004 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM4_2025.csv
# =============================================================================
...
SIM4_DIR = WORK_DIR / "Simulacao 004 segmentos"
...
OUT_FP  = SIM4_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM4_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM4_FP]:
    if not fp.exists():
...
agg = agg2.merge(agg4, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 004: Tabela de custos (SIM2 vs SIM4 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 004 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM4_2025.csv
#
# Saidas (todas em Simulacao 004 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM4_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM4_2025.csv   (economia)
# =============================================================================
...
IN_FP    = SIM4_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM4_2025.csv"
OUT_SIM2 = SIM4_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM4 = SIM4_DIR / "Tabela_demanda_consumo_por_posto_SIM4_2025.csv"
OUT_CMP  = SIM4_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM4_2025.csv"

# -------------------------
# DEMANDAS CONTRATADAS POR SIMULACAO
# -------------------------
CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM4 = {"DCFP": 5000.0, "DCP": 2200.0}  # 3000 - 800
...
print("DONE. Saved (Simulacao 004 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM4)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM4: DCFP=5000, DCP=2200")
print("\nResumo anual:")
print(cmp.tail(1))
