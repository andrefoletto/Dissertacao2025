# -*- coding: utf-8 -*-
# =============================================================================
# 021_SIM20_6BESS_2028_SEM_regulacao_tensao.py
#
# Regras deste script:
...
#     Simulacao 020 SEM regulacao tensao_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 020 SEM regulacao tensao_ano_2028
# =============================================================================
...
# Probes trifasicos praticamente nulos para registrar diretamente as barras BT.
# O consumo de 1e-6 kW por probe e desprezivel para o fluxo de potencia.
VOLTAGE_PROBES = {
...
DIR_PASS1 = WORK_DIR / "Simulacao 020 SEM regulacao tensao_pass1_sem_hvac_int_ano_2028"
...
DIR_PASS2 = WORK_DIR / "Simulacao 020 SEM regulacao tensao_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 020 SEM regulacao tensao_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 020 SEM regulacao tensao_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 020 SEM regulacao tensao_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 020 SEM regulacao tensao_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 020 SEM regulacao tensao_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 020 SEM regulacao tensao_ano_2028/Curva_de_Carga_<KEY>_sim_20.csv
...
OUT_FP = DIR_PASS2 / "Tensoes_medias_anuais_SEM_regulacao_sim_20.csv"
hora = np.round(np.arange(0.0, 8760.0, DT_H), 10)
...
#   Simulacao 020 SEM regulacao tensao_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 020 SEM regulacao tensao_ano_2028/Resumo_EnergyMeter_Geral_Sim20.csv
# =============================================================================
...
# Saida:
#   Simulacao 020 SEM regulacao tensao_ano_2028/01_Integralizacao_Mensal_SIM20_2028.csv
#
# Observacao:
...
SIM20_DIR = WORK_DIR / f"Simulacao 020 SEM regulacao tensao_ano_{ANO_ANALISE}"
...
#
# Saida:
#   Simulacao 020 SEM regulacao tensao_ano_2028/Tabela_demanda_consumo_por_posto_SIM20_2028.csv
#
