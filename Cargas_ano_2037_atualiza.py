# -*- coding: utf-8 -*-
"""
Atualiza curvas de carga em pu para o ano de 2037, a partir do ano-base de 2025.

Premissa:
- Crescimento linear da carga: 0,5% ao ano
- Período considerado: 2025 até 2037 = 12 anos
- Fator aplicado: 1 + 0,005 * 12 = 1,060
...
ATENÇÃO: execute apenas uma vez sobre os arquivos ainda não corrigidos para 2037.
Para evitar aplicação duplicada acidental, o script cria um arquivo de controle
".ajuste_cargas_2037_aplicado.flag" em cada pasta processada com sucesso.
"""
...
ARQUIVO_CONTROLE = ".ajuste_cargas_2037_aplicado.flag"

PASTAS = [
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Especiais_ano_2037"),
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Estimadas_com_residuo_ano_2037"),
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Medidas_ano_2037"),
]
...
print("=" * 78)
print("ATUALIZAÇÃO DAS CURVAS DE CARGA PARA O ANO DE 2037")
...
for pasta in PASTAS:
    ...
    if USAR_ARQUIVO_CONTROLE and flag_path.exists():
        print(f"[PULADO] Ajuste de 2037 já aplicado anteriormente nesta pasta.")
    ...
    if USAR_ARQUIVO_CONTROLE and processados_pasta > 0 and erros_pasta == 0:
        flag_path.write_text(
            "Ajuste das cargas para 2037 aplicado com sucesso.\n"
            f"Ano-base: {ANO_BASE}\n"
            f"Ano-alvo: {ANO_ALVO}\n"
