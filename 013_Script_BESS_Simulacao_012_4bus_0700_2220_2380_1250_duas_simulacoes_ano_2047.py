# -*- coding: utf-8 -*-
# =============================================================================
# 013_Script_BESS_Simulacao_012_4bus_0700_2220_2380_1250_duas_simulacoes_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 012 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 012 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 012 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 012 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_12.csv
# Remove:
...
#   Simulacao 012 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 012 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim12.csv
# =============================================================================
...
# Saida:
#   Simulacao 012 segmentos_ano_2047/01_Integralizacao_Mensal_SIM12_2047.csv
#
# Observacao:
...
#
# Saida:
#   Simulacao 012 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM12_2047.csv
#
...
# - A demanda contratada de ponta com 4 BESS considera abatimento de 4 x 673 kW, potencia remanescente dos bancos em 2047.
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - NUM_BESS * BESS_P_KW) # 638 kW em 2047
