# -*- coding: utf-8 -*-
# =============================================================================
# 019_Script_BESS_Simulacao_018_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado.py
#
# Regras deste script:
...
#     Simulacao 018 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 018 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 018 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 018 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 018 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 018 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 018 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 018 segmentos/Curva_de_Carga_<KEY>_sim_18.csv
# Remove:
...
#   Simulacao 018 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 018 segmentos/Resumo_EnergyMeter_Geral_Sim18.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM18)
# =============================================================================
# Entradas:
...
#   SIM18: Simulacao 018 segmentos/Curva_de_Carga_GERAL_sim_18.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 018 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM18_2025.csv
# =============================================================================
...
SIM18_DIR = WORK_DIR / "Simulacao 018 segmentos"
...
OUT_FP = SIM18_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM18_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM18_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM18", sim18, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df18 = meta.merge(sim18, on="k", how="left").rename(columns={"P_3f_S": "P_SIM18", "Q_3f_S": "Q_SIM18"})
...
agg = agg2.merge(agg18, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 018: Tabela de custos (SIM2 vs SIM18 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM18_2025.csv
#
# Saidas (todas em Simulacao 018 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM18_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM18_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM18_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM18_2025.csv"
OUT_SIM2 = SIM18_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM18 = SIM18_DIR / "Tabela_demanda_consumo_por_posto_SIM18_2025.csv"
OUT_CMP = SIM18_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM18_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM18 = {"DCFP": 5000.0, "DCP":   0.0}  # 3000 - 3*800
...
tab18 = tabela_custos(df, "SIM18", DCFP=CONTR_SIM18["DCFP"], DCP=CONTR_SIM18["DCP"])
...
print("DONE. Saved (Simulacao 018 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM18)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM18: DCFP=5000, DCP=0")
print("\nResumo anual:")
print(cmp.tail(1))
