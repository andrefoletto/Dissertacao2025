# -*- coding: utf-8 -*-
"""
Atualiza curvas de carga em pu para o ano de 2030, a partir do ano-base de 2025.

Premissa:
- Crescimento linear da carga: 0,5% ao ano
- Período considerado: 2025 até 2030 = 5 anos
- Fator aplicado: 1 + 0,005 * 5 = 1,025
...
ATENÇÃO: execute apenas uma vez sobre os arquivos ainda não corrigidos para 2030.
Para evitar aplicação duplicada acidental, o script cria um arquivo de controle
".ajuste_cargas_2030_aplicado.flag" em cada pasta processada com sucesso.
"""
...
ARQUIVO_CONTROLE = ".ajuste_cargas_2030_aplicado.flag"

PASTAS = [
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Especiais_ano_2030"),
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Estimadas_com_residuo_ano_2030"),
    Path(r"C:\Users\afole\OneDrive\Dissertacao2025\Cargas_Medidas_ano_2030"),
]
...
print("=" * 78)
print("ATUALIZAÇÃO DAS CURVAS DE CARGA PARA O ANO DE 2030")
...
for pasta in PASTAS:
    ...
    if USAR_ARQUIVO_CONTROLE and flag_path.exists():
        print(f"[PULADO] Ajuste de 2030 já aplicado anteriormente nesta pasta.")
    ...
    if USAR_ARQUIVO_CONTROLE and processados_pasta > 0 and erros_pasta == 0:
        flag_path.write_text(
            "Ajuste das cargas para 2030 aplicado com sucesso.\n"
            f"Ano-base: {ANO_BASE}\n"
            f"Ano-alvo: {ANO_ALVO}\n"
