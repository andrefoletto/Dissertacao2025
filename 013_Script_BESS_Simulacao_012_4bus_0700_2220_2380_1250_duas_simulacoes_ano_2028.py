# -*- coding: utf-8 -*-
# =============================================================================
# 013_Script_BESS_Simulacao_012_4bus_0700_2220_2380_1250_duas_simulacoes_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 012 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2028"
...
DIR_PASS2 = WORK_DIR / "Simulacao 012 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 012 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 012 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_12.csv
# Remove:
...
#   Simulacao 012 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 012 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim12.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM12 - ANO 2028, 4 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM12: curva GERAL com 4 BESS para o ano 2028
# Saida:
#   Simulacao 012 segmentos_ano_2028/01_Integralizacao_Mensal_SIM12_2028.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 4 BESS do ano 2028 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 012: tabela de custos (SIM12 - ANO 2028, 4 BESS)
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2028/01_Integralizacao_Mensal_SIM12_2028.csv
#
# Saida:
#   Simulacao 012 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM12_2028.csv
#
...
# - A demanda contratada de ponta com 4 BESS considera abatimento de 4 x 800 kW.
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - NUM_BESS * BESS_P_KW) # 0 kW em 2028
...
print("DONE. Saved (Simulacao 012 - 4 BESS - 2028):")
print(" -", OUT_SIM12)
