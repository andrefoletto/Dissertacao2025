# -*- coding: utf-8 -*-
# =============================================================================
# 023_Script_BESS_Simulacao_022_3bus_0700_2220_2380_duas_simulacoes_conjugado_4500_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 022 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 022 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 022 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=3928 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 022 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 022 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 022 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 022 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 022 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_22.csv
# Remove:
...
#   Simulacao 022 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 022 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim22.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM22 - ANO 2047, 3 BESS degradados)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM22: curva GERAL com 3 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 022 segmentos_ano_2047/01_Integralizacao_Mensal_SIM22_2047.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 022: tabela de custos (SIM22 - ANO 2047, 3 BESS degradados)
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos_ano_2047/01_Integralizacao_Mensal_SIM22_2047.csv
#
# Saida:
#   Simulacao 022 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM22_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP com BESS = 4995 kW  (corte fora-ponta agressivo)
#   DCP sem BESS = 3330 kW
#   DCP com 3 BESS = 3330 - 2020 = 1310 kW
#
# Banco de energia:
#   3 BESS de 1 MW / 4,667 MWh instalados em 2028.
#   Operacao nova a 80% da potencia nominal: 800 kW por banco.
#   Em 2047, considera-se SOH = 84,1666667%.
#   Potencia operacional degradada por banco = 800 * 0,8416666667 = 673,333 kW.
#   Energia degradada adotada por banco = 3928 kWh.
...
# - Cada banco possui 1 MW / 4,667 MWh nominal.
# - A potencia operacional nova e 80% da potencia nominal: 800 kW por banco.
# - Em 2047, usa-se SOH = 84,1666667%.
# - A potencia considerada para reducao da DCP e calculada por conjunto:
#   3 * (800 * 0,8416666667) = 2020 kW.
# - A energia degradada adotada no OpenDSS e 3928 kWh por banco.
...
BESS_P_UNITARIA_KW = BESS_P_NOVA_OPERACIONAL_KW * BESS_SOH_2047
BESS_E_NOMINAL_UNITARIA_KWH = 4667.0
BESS_E_UNITARIA_KWH = 3928.0
BESS_RESERVA_PONTA_PCT = 64.3

BESS_P_TOTAL_KW = round(NUM_BESS * BESS_P_UNITARIA_KW, 0)     # 2020 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH             # 11784 kWh
...
DCP_SEM_BESS = 3330.0
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)       # 1310 kW
...
print("DONE. Saved (Simulacao 022 - 3 BESS - 2047 - conjugado 4500):")
print(" -", OUT_SIM22)
