# -*- coding: utf-8 -*-
# =============================================================================
# 020_Script_BESS_Simulacao_019_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_5000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 019 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 019 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 019 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3300 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
# %% Celula 003 - PASSO 1: monitores -> Curva_de_Carga_BESSM1_IN_sim_19.csv, BESSM2_IN, BESSM3_IN, BESSM4_IN e BESSM5_IN (SHIFT DIREITA)
# =============================================================================
# Entradas:
#   PASSO1/Monitor_BESSM1_IN_anual.csv
#   PASSO1/Monitor_BESSM2_IN_anual.csv
...
#   PASSO1/Curva_de_Carga_BESSM5_IN_sim_19.csv
# Remove:
#   PASSO1/Monitor_BESSM1_IN_anual.csv
#   PASSO1/Monitor_BESSM2_IN_anual.csv
#   PASSO1/Monitor_BESSM3_IN_anual.csv
...
DIR_PASS2 = WORK_DIR / "Simulacao 019 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 019 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 019 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 019 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 019 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 019 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 019 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_19.csv
# Remove:
...
#   Simulacao 019 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 019 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim19.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM19 - ANO 2028, 5 BESS 1 MW / 3,3 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM19: curva GERAL com 5 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 019 segmentos_ano_2028/01_Integralizacao_Mensal_SIM19_2028.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 5 BESS do ano 2028 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 019: tabela de custos (SIM19 - ANO 2028, 5 BESS 1 MW / 3,3 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 019 segmentos_ano_2028/01_Integralizacao_Mensal_SIM19_2028.csv
#
# Saida:
#   Simulacao 019 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM19_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP = 5075 kW
#   DCP sem BESS = 3000 kW * (1 + 3 * 0,5%) = 3045 kW
#   DCP com 5 BESS = max(0, 3045 - (5 x 800)) = 0 kW
#
# Configuracao energetica dos BESS:
#   5 bancos de 1 MW / 3,3 MWh, operando com kWrated=800 kW por banco.
#   Energia total = 5 x 3300 = 16500 kWh.
#   Reserva para ponta = 15000 kWh.
#   Energia disponivel para peak-shave fora-ponta = 1500 kWh.
#   Percentual de reserva para ponta = 15000 / 16500 = 90,9%.
#
# Observacao:
...
# - Os 5 BESS sao instalados no proprio ano de analise.
# - Cada banco possui transformador de 1000 kVA, mas opera com kWrated=800 kW e 3300 kWh.
# - Assim, o conjunto reduz a DCP em 5 x 800 = 4000 kW e totaliza 16500 kWh.
...
BESS_E_UNITARIA_KWH = 3300.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 4000 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 16500 kWh

# Separacao operacional da energia:
# - 15000 kWh reservados para load-shift no horario de ponta;
# - 1500 kWh disponiveis para peak-shave fora-ponta.
BESS_E_RESERVA_PONTA_KWH = 15000.0
