# -*- coding: utf-8 -*-
# =============================================================================
# 014_Script_BESS_Simulacao_013_5bus_0700_2220_2380_1250_1630_duas_simulacoes_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 013 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 013 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 013 segmentos_pass1_sem_hvac_int_ano_2028"
...
DIR_PASS2 = WORK_DIR / "Simulacao 013 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 013 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 013 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 013 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 013 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_13.csv
# Remove:
...
#   Simulacao 013 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 013 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim13.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM13 - ANO 2028, 5 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM13: curva GERAL com 5 BESS para o ano 2028
# Saida:
#   Simulacao 013 segmentos_ano_2028/01_Integralizacao_Mensal_SIM13_2028.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 5 BESS do ano 2028 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 013: tabela de custos (SIM13 - ANO 2028, 5 BESS)
# =============================================================================
# Entrada:
#   Simulacao 013 segmentos_ano_2028/01_Integralizacao_Mensal_SIM13_2028.csv
#
# Saida:
#   Simulacao 013 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM13_2028.csv
#
...
# - A demanda contratada de ponta com 5 BESS considera abatimento de 5 x 800 kW.
