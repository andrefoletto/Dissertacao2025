# -*- coding: utf-8 -*-
# =============================================================================
# 022_Script_BESS_Simulacao_021_2bus_0700_2220_duas_simulacoes_conjugado_4500_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 021 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 021 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 021 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=4629 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 021 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 021 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 021 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 021 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 021 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_21.csv
# Remove:
...
#   Simulacao 021 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 021 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim21.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM21 - ANO 2047, 2 BESS 673 kW / 4,629 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM21: curva GERAL com 2 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 021 segmentos_ano_2047/01_Integralizacao_Mensal_SIM21_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 2 BESS do ano 2047 por mes e posto.
...
# %% Celula 011 - SIMULACAO 021: tabela de custos (SIM21 - ANO 2047, 2 BESS 673 kW / 4,629 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos_ano_2047/01_Integralizacao_Mensal_SIM21_2047.csv
#
# Saida:
#   Simulacao 021 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM21_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP com BESS = 4995 kW  (corte fora-ponta agressivo)
#   DCP sem BESS = 3885 kW
#   DCP com 2 BESS = 3885 - (2 * 673) = 2539 kW
#
# Banco de energia:
#   2 BESS de 1 MW / 5,5 MWh instalados em 2028.
#   Em 2047, considera-se SOH = 84,1666667%.
#   Potencia operacional por banco em 2047 = 673 kW.
#   Energia por banco em 2047 = 4629 kWh.
...
# - Cada banco possui 1 MW / 5,5 MWh nominal.
# - A potencia operacional nova e 80% da potencia nominal: 800 kW por banco.
# - Em 2047, a potencia operacional degradada adotada e 673 kW por banco.
# - Em 2047, a energia degradada adotada e 4629 kWh por banco.
# - A demanda contratada fora-ponta foi reduzida de forma agressiva para 4995 kW.
# - A demanda contratada de ponta sem BESS adotada e 3885 kW.
NUM_BESS = 2
...
BESS_E_NOMINAL_UNITARIA_KWH = 5500.0
BESS_E_UNITARIA_KWH = 4629.0
BESS_RESERVA_PONTA_PCT = 54.5

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW                 # 1346 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH               # 9258 kWh
...
DCP_SEM_BESS = 3885.0
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)         # 2539 kW
...
print("DONE. Saved (Simulacao 021 - 2 BESS - 2047 - conjugado 4500):")
print(" -", OUT_SIM21)
