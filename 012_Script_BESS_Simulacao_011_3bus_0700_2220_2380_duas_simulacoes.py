# -*- coding: utf-8 -*-
# =============================================================================
# 012_Script_BESS_Simulacao_011_3bus_0700_2220_2380_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 011 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 011 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 011 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 011 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 011 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 011 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 011 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 011 segmentos/Curva_de_Carga_<KEY>_sim_11.csv
# Remove:
...
#   Simulacao 011 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 011 segmentos/Resumo_EnergyMeter_Geral_Sim11.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM11)
# =============================================================================
# Entradas:
...
#   SIM11: Simulacao 011 segmentos/Curva_de_Carga_GERAL_sim_11.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 011 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM11_2025.csv
# =============================================================================
...
SIM11_DIR = WORK_DIR / "Simulacao 011 segmentos"
...
OUT_FP = SIM11_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM11_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM11_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM11", sim11, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df11 = meta.merge(sim11, on="k", how="left").rename(columns={"P_3f_S": "P_SIM11", "Q_3f_S": "Q_SIM11"})
...
agg = agg2.merge(agg11, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 011: Tabela de custos (SIM2 vs SIM11 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM11_2025.csv
#
# Saidas (todas em Simulacao 011 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM11_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM11_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM11_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM11_2025.csv"
OUT_SIM2 = SIM11_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM11 = SIM11_DIR / "Tabela_demanda_consumo_por_posto_SIM11_2025.csv"
OUT_CMP = SIM11_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM11_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM11 = {"DCFP": 5000.0, "DCP": 600.0}  # 3000 - 2*400
...
tab11 = tabela_custos(df, "SIM11", DCFP=CONTR_SIM11["DCFP"], DCP=CONTR_SIM11["DCP"])
...
print("DONE. Saved (Simulacao 011 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM11)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM11: DCFP=5000, DCP=600")
print("\nResumo anual:")
print(cmp.tail(1))
