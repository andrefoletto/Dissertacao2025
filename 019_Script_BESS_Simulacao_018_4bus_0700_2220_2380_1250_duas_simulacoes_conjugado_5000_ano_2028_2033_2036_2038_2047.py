# -*- coding: utf-8 -*-
# =============================================================================
# 019_Script_BESS_Simulacao_018_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado_5000_ano_2028_2033_2036_2038_2047.py
#
# Regras deste script:
...
#     Simulacao 018 segmentos_pass1_sem_hvac_int_ano_2038_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 018 segmentos_ano_2038_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 018 segmentos_pass1_sem_hvac_int_ano_2038_2047"
...
#     SOC_15min_BESS_SIM18_2047.csv          (SOC dos quatro bancos a cada 15 min)
#
# Requisitos:
...
DIR_PASS2 = WORK_DIR / "Simulacao 018 segmentos_ano_2038_2047"
...
if LIMPAR_SAIDAS_ANTERIORES_PASS2:
    padroes_limpeza = [
        ...
        "EXP_MTR_GERAL*.csv",
        "Resumo_EnergyMeter_Geral_Sim18.csv",
        "SOC_por_segmento.csv",
        "SOC_15min_BESS_SIM18_2047.csv",
        "01_Integralizacao_Mensal_SIM18_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM18_2047.csv",
    ]
    removidos = 0
...
soc_15min_fp = DIR_PASS2 / "SOC_15min_BESS_SIM18_2047.csv"
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2038_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 018 segmentos_ano_2038_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2038_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 018 segmentos_ano_2038_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 018 segmentos_ano_2038_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 018 segmentos_ano_2038_2047/Curva_de_Carga_<KEY>_sim_18.csv
# Remove:
...
#   Simulacao 018 segmentos_ano_2038_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 018 segmentos_ano_2038_2047/Resumo_EnergyMeter_Geral_Sim18.csv
# =============================================================================
...
OUT_FP = DIR_PASS2 / "Resumo_EnergyMeter_Geral_Sim18.csv"
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM18 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entradas:
...
#          para o ano 2047.
# Saida:
#   Simulacao 018 segmentos_ano_2038_2047/01_Integralizacao_Mensal_SIM18_2047.csv
#
# Observacao:
...
#            degradado em 2047 por fator 0,925 para 740 kW / 2775 kWh.
...
SIM18_DIR = WORK_DIR / "Simulacao 018 segmentos_ano_2038_2047"
...
# %% Celula 011 - SIMULACAO 018: tabela de custos (SIM18 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2038_2047/01_Integralizacao_Mensal_SIM18_2047.csv
#
# Saida:
#   Simulacao 018 segmentos_ano_2038_2047/Tabela_demanda_consumo_por_posto_SIM18_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP contratada com BESS = 5000 * 1,11 = 5550 kW
...
#   DCP com BESS = 3330 - (673 + 707 + 727 + 740) = 483 kW
#
...
#     Em 2047: fator 0,925 -> 740 kW / 2775 kWh.
...
# -------------------------
# Fora-ponta: 5000 * 1,11 = 5550 kW
# Ponta sem BESS: 3000 * 1,11 = 3330 kW
# Ponta com BESS: 3330 - (673 + 707 + 727 + 740) = 483 kW
DCP_SEM_BESS = 3330.0
...
BESS1_FATOR_DEGRADACAO_2047 = 0.841666667
...
BESS2_FATOR_DEGRADACAO_2047 = 0.883333333
...
BESS3_FATOR_DEGRADACAO_2047 = 0.908333333
...
BESS4_FATOR_DEGRADACAO_2047 = 0.925
...
print("DONE. Saved (Simulacao 018 - BESS modular autofinanciado - 2047 - conjugado):")
print(" -", OUT_SIM18)
