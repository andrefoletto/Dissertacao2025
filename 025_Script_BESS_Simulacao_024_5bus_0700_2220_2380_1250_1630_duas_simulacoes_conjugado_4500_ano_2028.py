# -*- coding: utf-8 -*-
# =============================================================================
# 025_Script_BESS_Simulacao_024_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_4500_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 024 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2028"
...
# %% Celula 003 - PASSO 1: monitores -> Curva_de_Carga_BESSM1_IN_sim_24.csv, BESSM2_IN, BESSM3_IN, BESSM4_IN e BESSM5_IN (SHIFT DIREITA)
# =============================================================================
# Entradas:
#   PASSO1/Monitor_BESSM1_IN_anual.csv
#   PASSO1/Monitor_BESSM2_IN_anual.csv
...
#   PASSO1/Curva_de_Carga_BESSM5_IN_sim_24.csv
# Remove:
#   PASSO1/Monitor_BESSM1_IN_anual.csv
#   PASSO1/Monitor_BESSM2_IN_anual.csv
#   PASSO1/Monitor_BESSM3_IN_anual.csv
...
DIR_PASS2 = WORK_DIR / "Simulacao 024 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 024 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 024 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_24.csv
# Remove:
...
#   Simulacao 024 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 024 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim24.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM24 - ANO 2028, 5 BESS 800 kW / 4,0 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM24: curva GERAL com 5 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 024 segmentos_ano_2028/01_Integralizacao_Mensal_SIM24_2028.csv
#
# Observacao:
...
#   Nao ha fallback: a curva GERAL deve estar em Curva_de_Carga_GERAL_sim_24.csv.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 024: tabela de custos (SIM24 - ANO 2028, 5 BESS 800 kW / 4,0 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2028/01_Integralizacao_Mensal_SIM24_2028.csv
#
# Saida:
#   Simulacao 024 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM24_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP com BESS = 4568 kW  (corte fora-ponta agressivo: 4500 kW * 1,015)
#   DCP sem BESS = 3045 kW
#   DCP com 5 BESS = max(0, 3045 - (5 * 800)) = 0 kW
#
# Banco de energia:
#   5 BESS de 1 MW / 4,0 MWh, operando a 80% da potencia nominal.
#   Potencia operacional total = 4000 kW.
#   Energia total = 20000 kWh.
#   Reserva de ponta = 75,0%.
#   Energia reservada para ponta = 15000 kWh.
#   Energia disponivel para peak-shave fora-ponta = 5000 kWh.
...
# - Cada banco possui 1 MW / 4,0 MWh nominal, mas opera com 800 kW de potencia.
...
BESS_E_UNITARIA_KWH = 4000.0
BESS_RESERVA_PONTA_PCT = 75.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 4000 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 20000 kWh
...
print("DONE. Saved (Simulacao 024 - 5 BESS - 2028 - conjugado 4500):")
print(" -", OUT_SIM24)
