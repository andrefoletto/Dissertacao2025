# -*- coding: utf-8 -*-
# =============================================================================
# 011_Script_BESS_Simulacao_010_2bus_0700_2220_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 010 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 010 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 010 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 010 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 010 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 010 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 010 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 010 segmentos/Curva_de_Carga_<KEY>_sim_10.csv
# Remove:
...
#   Simulacao 010 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 010 segmentos/Resumo_EnergyMeter_Geral_Sim10.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM10)
# =============================================================================
# Entradas:
...
#   SIM10: Simulacao 010 segmentos/Curva_de_Carga_GERAL_sim_10.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 010 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM10_2025.csv
# =============================================================================
...
SIM10_DIR = WORK_DIR / "Simulacao 010 segmentos"
...
OUT_FP = SIM10_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM10_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM10_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM10", sim10, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df10 = meta.merge(sim10, on="k", how="left").rename(columns={"P_3f_S": "P_SIM10", "Q_3f_S": "Q_SIM10"})
...
agg = agg2.merge(agg10, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 010: Tabela de custos (SIM2 vs SIM10 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 010 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM10_2025.csv
#
# Saidas (todas em Simulacao 010 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM10_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM10_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM10_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM10_2025.csv"
OUT_SIM2 = SIM10_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM10 = SIM10_DIR / "Tabela_demanda_consumo_por_posto_SIM10_2025.csv"
OUT_CMP = SIM10_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM10_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM10 = {"DCFP": 5000.0, "DCP": 1400.0}  # 3000 - 2*800
...
tab10 = tabela_custos(df, "SIM10", DCFP=CONTR_SIM10["DCFP"], DCP=CONTR_SIM10["DCP"])
...
print("DONE. Saved (Simulacao 010 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM10)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM10: DCFP=5000, DCP=1400")
print("\nResumo anual:")
print(cmp.tail(1))
