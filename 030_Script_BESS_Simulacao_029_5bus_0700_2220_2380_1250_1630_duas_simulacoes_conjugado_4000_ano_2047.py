# -*- coding: utf-8 -*-
# =============================================================================
# 030_Script_BESS_Simulacao_029_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_4000_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 029 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 029 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 029 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=4545 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 029 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 029 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 029 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 029 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 029 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 029 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 029 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_29.csv
# Remove:
...
#   Simulacao 029 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 029 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim29.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM29 - ANO 2047, 5 BESS degradados 673 kW / 4,545 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM29: curva GERAL com 5 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 029 segmentos_ano_2047/01_Integralizacao_Mensal_SIM29_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 5 BESS degradados do ano 2047 por mes e posto.
...
# %% Celula 011 - SIMULACAO 029: tabela de custos (SIM29 - ANO 2047, 5 BESS degradados 673 kW / 4,545 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 029 segmentos_ano_2047/01_Integralizacao_Mensal_SIM29_2047.csv
#
# Saida:
#   Simulacao 029 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM29_2047.csv
#
# Demandas contratadas e limites de despacho do ano 2047:
#   DCFP com BESS = 4440 kW  (corte fora-ponta agressivo: 4000 kW * 1,11)
#   Recarga fora-ponta permitida ate = 3885 kW
#   DCP sem BESS = 3330 kW
#   DCP com 5 BESS = max(0, 3330 - (5 * 673)) = 0 kW
#
# Banco de energia:
#   5 BESS de 1 MW / 5,4 MWh instalados em 2028 e degradados para 2047.
#   Operacao a 80% da potencia nominal na instalacao.
#   Potencia operacional degradada total = 3365 kW.
#   Energia nominal total = 27000 kWh.
#   Energia degradada total = 22725 kWh.
#   Reserva de ponta = 55,6% = 15/27.
#   Energia reservada para ponta ~= 12635 kWh.
#   Energia disponivel para peak-shave fora-ponta ~= 10090 kWh.
#
# Observacao:
...
# -------------------------
# Demandas contratadas e limites de despacho
# -------------------------
# Premissas:
# - Ano de instalacao dos BESS = 2028.
# - Ano de analise = 2047.
# - Os bancos foram degradados para os valores usados no OpenDSS em 2047.
# - A demanda contratada fora-ponta foi reduzida de forma mais agressiva para 4440 kW.
# - A recarga fora-ponta fica permitida ate 3885 kW.
# - Cada banco possui 1 MW / 5,4 MWh nominal, opera a 80% da potencia nominal
#   na instalacao, e chega em 2047 com 673 kW e 4545 kWh.
...
BESS_E_NOMINAL_UNITARIA_KWH = 5400.0
BESS_E_UNITARIA_KWH = 4545.0
BESS_RESERVA_PONTA_PCT = 55.6

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW                       # 3365 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH                     # 22725 kWh
BESS_E_NOMINAL_TOTAL_KWH = NUM_BESS * BESS_E_NOMINAL_UNITARIA_KWH     # 27000 kWh
...
DCP_SEM_BESS = 3330.0
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)               # 0 kW
...
print("DONE. Saved (Simulacao 029 - 5 BESS - 2047 - conjugado 4000):")
print(" -", OUT_SIM29)
print("\nDemandas contratadas usadas em 2047:")
print(f" - DCFP = {DCFP_COM_BESS:.0f} kW")
print(f" - Recarga fora-ponta permitida ate = {KW_TARGET_LOW_FP:.0f} kW")
