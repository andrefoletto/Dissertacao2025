# -*- coding: utf-8 -*-
# =============================================================================
# 019_Script_BESS_Simulacao_018_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado_5000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 018 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 018 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 018 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3375 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 018 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 018 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 018 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 018 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 018 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_18.csv
# Remove:
...
#   Simulacao 018 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 018 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim18.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM18 - ANO 2028, 4 BESS 800 kW / 3,375 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM18: curva GERAL com 4 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 018 segmentos_ano_2028/01_Integralizacao_Mensal_SIM18_2028.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 018: tabela de custos (SIM18 - ANO 2028, 4 BESS 800 kW / 3,375 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 018 segmentos_ano_2028/01_Integralizacao_Mensal_SIM18_2028.csv
#
# Saida:
#   Simulacao 018 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM18_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP = 5075 kW
#   DCP sem BESS = 3000 kW * (1 + 3 * 0,5%) = 3045 kW
#   DCP com 4 BESS = max(0, 3045 - (4 x 800)) = 0 kW
#
# Observacao:
...
# - Cada banco possui transformador de 1000 kVA, mas opera com kWrated=800 kW e 3375 kWh.
# - Assim, o conjunto reduz a DCP em 4 x 800 = 3200 kW e totaliza 13500 kWh.
...
BESS_E_UNITARIA_KWH = 3375.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 3200 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 13500 kWh

# Separacao operacional da energia:
# - 12000 kWh reservados para load-shift no horario de ponta;
# - 1500 kWh disponiveis para peak-shave fora-ponta.
BESS_E_RESERVA_PONTA_KWH = 12000.0
...
if not IN_FP.exists():
    raise FileNotFoundError(
        f"Nao encontrei {IN_FP}. Execute primeiro a Celula 010 para gerar a integralizacao mensal."
    )
...
print("DONE. Saved (Simulacao 018 - 4 BESS - 2028 - conjugado):")
print(" -", OUT_SIM18)
