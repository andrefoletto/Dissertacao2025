# -*- coding: utf-8 -*-
# =============================================================================
# 017_Script_BESS_Simulacao_016_2bus_0700_2220_duas_simulacoes_conjugado_5000.py
#
# Regras deste script:
...
#     Simulacao 016 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 016 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 016 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 016 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 016 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 016 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 016 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 016 segmentos/Curva_de_Carga_<KEY>_sim_16.csv
# Remove:
...
#   Simulacao 016 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 016 segmentos/Resumo_EnergyMeter_Geral_Sim16.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM16)
# =============================================================================
# Entradas:
...
#   SIM16: Simulacao 016 segmentos/Curva_de_Carga_GERAL_sim_16.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 016 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM16_2025.csv
# =============================================================================
...
SIM16_DIR = WORK_DIR / "Simulacao 016 segmentos"
...
OUT_FP = SIM16_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM16_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM16_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM16", sim16, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df16 = meta.merge(sim16, on="k", how="left").rename(columns={"P_3f_S": "P_SIM16", "Q_3f_S": "Q_SIM16"})
...
agg = agg2.merge(agg16, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 016: Tabela de custos (SIM2 vs SIM16 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM16_2025.csv
#
# Saidas (todas em Simulacao 016 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM16_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM16_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM16_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM16_2025.csv"
OUT_SIM2 = SIM16_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM16 = SIM16_DIR / "Tabela_demanda_consumo_por_posto_SIM16_2025.csv"
OUT_CMP = SIM16_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM16_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM16 = {"DCFP": 5000.0, "DCP": 1400.0}  # 3000 - 2*800
...
tab16 = tabela_custos(df, "SIM16", DCFP=CONTR_SIM16["DCFP"], DCP=CONTR_SIM16["DCP"])
...
print("DONE. Saved (Simulacao 016 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM16)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM16: DCFP=5000, DCP=1400")
print("\nResumo anual:")
print(cmp.tail(1))
