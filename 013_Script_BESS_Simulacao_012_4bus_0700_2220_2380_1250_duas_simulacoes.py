# -*- coding: utf-8 -*-
# =============================================================================
# 013_Script_BESS_Simulacao_012_4bus_0700_2220_2380_1250_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 012 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 012 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 012 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 012 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 012 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 012 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 012 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 012 segmentos/Curva_de_Carga_<KEY>_sim_12.csv
# Remove:
...
#   Simulacao 012 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 012 segmentos/Resumo_EnergyMeter_Geral_Sim12.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM12)
# =============================================================================
# Entradas:
...
#   SIM12: Simulacao 012 segmentos/Curva_de_Carga_GERAL_sim_12.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 012 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM12_2025.csv
# =============================================================================
...
SIM12_DIR = WORK_DIR / "Simulacao 012 segmentos"
...
OUT_FP = SIM12_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM12_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM12_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM12", sim12, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df12 = meta.merge(sim12, on="k", how="left").rename(columns={"P_3f_S": "P_SIM12", "Q_3f_S": "Q_SIM12"})
...
agg = agg2.merge(agg12, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 012: Tabela de custos (SIM2 vs SIM12 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM12_2025.csv
#
# Saidas (todas em Simulacao 012 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM12_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM12_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM12_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM12_2025.csv"
OUT_SIM2 = SIM12_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM12 = SIM12_DIR / "Tabela_demanda_consumo_por_posto_SIM12_2025.csv"
OUT_CMP = SIM12_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM12_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM12 = {"DCFP": 5000.0, "DCP":   0.0}  # 3000 - 3*800
...
tab12 = tabela_custos(df, "SIM12", DCFP=CONTR_SIM12["DCFP"], DCP=CONTR_SIM12["DCP"])
...
print("DONE. Saved (Simulacao 012 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM12)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM12: DCFP=5000, DCP=0")
print("\nResumo anual:")
print(cmp.tail(1))
