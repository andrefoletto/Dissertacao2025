# -*- coding: utf-8 -*-
# =============================================================================
# 029_Script_BESS_Simulacao_028_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado_4000_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 028 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 028 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 028 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=5050 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 028 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 028 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 028 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 028 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 028 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_28.csv
# Remove:
...
#   Simulacao 028 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 028 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim28.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM28 - ANO 2047, 4 BESS degradados, base 2028 4 x 6,0 MWh)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM28: curva GERAL com 4 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 028 segmentos_ano_2047/01_Integralizacao_Mensal_SIM28_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 4 BESS degradados do ano 2047 por mes e posto.
#   Base instalada em 2028: 4 x 6,0 MWh; degradado em 2047: 4 x 5,05 MWh.
...
# %% Celula 011 - SIMULACAO 028: tabela de custos (SIM28 - ANO 2047, 4 BESS degradados, base 2028 4 x 6,0 MWh)
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2047/01_Integralizacao_Mensal_SIM28_2047.csv
#
# Saida:
#   Simulacao 028 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM28_2047.csv
#
...
#
# Banco de energia:
#   4 BESS de 1 MW / 6,0 MWh instalados em 2028 e degradados para 2047.
#   Operacao nova a 80% da potencia nominal: 800 kW por banco.
#   Potencia operacional degradada adotada por banco = 673 kW.
#   Potencia operacional degradada total = 2692 kW.
#   Energia nominal total = 24000 kWh.
#   Energia degradada total = 20200 kWh.
...
# -------------------------
# Demandas contratadas e BESS
# -------------------------
# Premissas:
# - Os 4 BESS sao instalados em 2028 e analisados degradados em 2047.
# - Cada banco possui 1 MW / 6,0 MWh nominal.
# - Potencia operacional nova = 800 kW por banco.
# - Potencia operacional degradada adotada = 673 kW por banco.
# - Energia degradada adotada = 5050 kWh por banco.
# - A demanda contratada fora-ponta foi reduzida para 4440 kW.
# - A permissao de recarga fora-ponta foi definida em 3885 kW.
NUM_BESS = 4
...
BESS_E_NOMINAL_UNITARIA_KWH = 6000.0
BESS_E_UNITARIA_KWH = 5050.0
...
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH               # 20200 kWh
...
print("DONE. Saved (Simulacao 028 - 4 BESS degradados - 2047 - conjugado 4000):")
print(" -", OUT_SIM28)
