# -*- coding: utf-8 -*-
# =============================================================================
# 013_Script_BESS_Simulacao_012_4bus_0700_2220_2380_1250_duas_simulacoes_ano_2028_2034_2037_2039_2047.py
#
# Regras deste script:
...
#     Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2039_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 012 segmentos_ano_2039_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 012 segmentos_pass1_sem_hvac_int_ano_2039_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 012 segmentos_ano_2039_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2039_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2039_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2039_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 012 segmentos_ano_2039_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 012 segmentos_ano_2039_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 012 segmentos_ano_2039_2047/Curva_de_Carga_<KEY>_sim_12.csv
# Remove:
...
#   Simulacao 012 segmentos_ano_2039_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 012 segmentos_ano_2039_2047/Resumo_EnergyMeter_Geral_Sim12.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM12 - ANO 2047, 4 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM12: curva GERAL com 4 BESS para o ano 2047
# Saida:
#   Simulacao 012 segmentos_ano_2039_2047/01_Integralizacao_Mensal_SIM12_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 4 BESS do ano 2047 por mes e posto.
# =============================================================================
...
SIM12_DIR = WORK_DIR / "Simulacao 012 segmentos_ano_2039_2047"
...
# %% Celula 011 - SIMULACAO 012: tabela de custos (SIM12 - ANO 2047, 4 BESS)
# =============================================================================
# Entrada:
#   Simulacao 012 segmentos_ano_2039_2047/01_Integralizacao_Mensal_SIM12_2047.csv
#
# Saida:
#   Simulacao 012 segmentos_ano_2039_2047/Tabela_demanda_consumo_por_posto_SIM12_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP = 5000 kW * (1 + 22 * 0,5%) = 5550 kW
#   DCP sem BESS = 3000 kW * (1 + 22 * 0,5%) = 3330 kW
#   DCP com 4 BESS = 3330 - 2867 = 463 kW
#
# Observacao:
...
# - A demanda contratada de ponta com 4 BESS considera abatimento das potencias remanescentes dos bancos: 673, 713, 733 e 747 kW.
# - Para preservar o resultado operacional informado, usa-se P_BESS_TOTAL_KW = 2867 kW.
DCP_SEM_BESS = 3330.0
DCFP_COM_BESS = 5550.0

# Potencias remanescentes no ano de 2047:
...
# As potencias acima sao valores arredondados; o total informado para a contratacao e 2867 kW.
P_BESS_TOTAL_KW = 2867.0
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - P_BESS_TOTAL_KW)  # 463 kW
...
print("DONE. Saved (Simulacao 012 - 4 BESS - 2047):")
print(" -", OUT_SIM12)
