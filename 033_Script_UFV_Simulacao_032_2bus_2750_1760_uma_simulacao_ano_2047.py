# -*- coding: utf-8 -*-
# =============================================================================
# 033_Script_UFV_Simulacao_032_2bus_2750_1760_uma_simulacao_ano_2047.py
#
# Regras deste script:
...
# ======================================================================================
# Saidas:
#   Simulacao 032 segmentos_ano_2047/
...
DIR_PASS2 = WORK_DIR / "Simulacao 032 segmentos_ano_2047"
...
if LIMPAR_SAIDAS_ANTERIORES:
    padroes_limpeza = [
        "UFSM_Mon_*_s*.csv",
        "Monitor_*_anual.csv",
        "Curva_de_Carga_*_sim_32_2047.csv",
        "Curva_de_Carga_*_sim_32.csv",
        "EXP_MTR_GERAL*.csv",
        "Resumo_EnergyMeter_Geral_Sim32_2047.csv",
        "01_Integralizacao_Mensal_SIM32_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM32_2047.csv",
    ]
    removidos = 0
    for padrao in padroes_limpeza:
        for fp in DIR_PASS2.glob(padrao):
            if fp.is_file():
                fp.unlink()
                removidos += 1
    print(f"[CLEAN] SIM32 2047: {removidos} arquivo(s) antigo(s) removido(s) em {DIR_PASS2}")
...
# =============================================================================
# Entrada:
#   Simulacao 032 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 032 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 032 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 032 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
# Saidas:
#   Simulacao 032 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_32_2047.csv
# Remove:
...
for in_fp in files:
    ...
    out_fp = DIR_PASS2 / f"Curva_de_Carga_{mon_key}_sim_32_2047.csv"
...
#   Simulacao 032 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 032 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim32_2047.csv
# =============================================================================
...
OUT_FP = DIR_PASS2 / "Resumo_EnergyMeter_Geral_Sim32_2047.csv"
...
# %% Celula 006 - ENERGIA e DEMANDA MAX por mes e posto (SIM32 - 2047)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         (Hora_decimal, Mes, Posto)
#   SIM32: Simulacao 032 segmentos_ano_2047/Curva_de_Carga_GERAL_sim_32_2047.csv
#         (Hora_decimal, P_3f_S, Q_3f_S)
#
# Saida:
#   Simulacao 032 segmentos_ano_2047/01_Integralizacao_Mensal_SIM32_2047.csv
#
# OBSERVACAO:
#   - P > 0  -> consumo da rede
#   - P < 0  -> injecao na rede
...
WORK_DIR = Path(r"C:\Users\afole\OneDrive\Dissertacao2025")
SIM32_DIR = WORK_DIR / "Simulacao 032 segmentos_ano_2047"

META_FP = WORK_DIR / "00_dados_de_entrada_ano_letivo_2025_15min.csv"
SIM32_FP = SIM32_DIR / "Curva_de_Carga_GERAL_sim_32_2047.csv"
OUT_FP = SIM32_DIR / "01_Integralizacao_Mensal_SIM32_2047.csv"
...
# %% Celula 007 - SIMULACAO 031: Tabela de custos (SIM32 - 2047)
# =============================================================================
# Entrada:
#   Simulacao 032 segmentos_ano_2047/01_Integralizacao_Mensal_SIM32_2047.csv
#
# Saida:
#   Simulacao 032 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM32_2047.csv
#
# HIPOTESE ADOTADA:
...
IN_FP = SIM32_DIR / "01_Integralizacao_Mensal_SIM32_2047.csv"
OUT_SIM32 = SIM32_DIR / "Tabela_demanda_consumo_por_posto_SIM32_2047.csv"
...
print("DONE. Saved (Simulacao 032 segmentos_ano_2047):")
print(" -", OUT_SIM32)
