# -*- coding: utf-8 -*-
# =============================================================================
# 012_Script_BESS_Simulacao_011_3bus_0700_2220_2380_duas_simulacoes_ano_2028_2034_2037_2047.py
#
# Regras deste script:
...
#     Simulacao 011 segmentos_pass1_sem_hvac_int_ano_2037_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 011 segmentos_ano_2037_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 011 segmentos_pass1_sem_hvac_int_ano_2037_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 011 segmentos_ano_2037_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2037_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 011 segmentos_ano_2037_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2037_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 011 segmentos_ano_2037_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 011 segmentos_ano_2037_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 011 segmentos_ano_2037_2047/Curva_de_Carga_<KEY>_sim_11.csv
# Remove:
...
#   Simulacao 011 segmentos_ano_2037_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 011 segmentos_ano_2037_2047/Resumo_EnergyMeter_Geral_Sim11.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM11 - ANO 2047, 3 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM11: curva GERAL com 3 BESS para o ano 2047
# Saida:
#   Simulacao 011 segmentos_ano_2037_2047/01_Integralizacao_Mensal_SIM11_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 3 BESS do ano 2047 por mes e posto.
# =============================================================================
...
SIM11_DIR = WORK_DIR / "Simulacao 011 segmentos_ano_2037_2047"
...
# %% Celula 011 - SIMULACAO 011: tabela de custos (SIM11 - ANO 2047, 3 BESS)
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2037_2047/01_Integralizacao_Mensal_SIM11_2047.csv
#
# Saida:
#   Simulacao 011 segmentos_ano_2037_2047/Tabela_demanda_consumo_por_posto_SIM11_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP = 5000 kW * (1 + 22 * 0,5%) = 5550 kW
#   DCP sem BESS = 3000 kW * (1 + 22 * 0,5%) = 3330 kW
#   DCP com 3 BESS = 3330 - 2120 = 1210 kW
...
# - O BESS1 ja apresenta potencia remanescente de 673 kW.
# - O BESS2 ja apresenta potencia remanescente de 713 kW.
# - O BESS3, instalado em 2037, apresenta potencia remanescente de 733 kW.
...
P_BESS_TOTAL_KW = 2120.0                                      # soma arredondada: 673 + 713 + 733 ~= 2120 kW
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - P_BESS_TOTAL_KW)     # 1210 kW em 2047
...
print("DONE. Saved (Simulacao 011 segmentos_ano_2037_2047):")
print(" -", OUT_SIM11)
