# -*- coding: utf-8 -*-
# =============================================================================
# 021_Script_BESS_Simulacao_020_2bus_0700_2220_duas_simulacoes_conjugado_4500.py
#
# Regras deste script:
...
#     Simulacao 021 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 021 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 021 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 021 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 021 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 021 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 021 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 021 segmentos/Curva_de_Carga_<KEY>_sim_21.csv
# Remove:
...
#   Simulacao 021 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 021 segmentos/Resumo_EnergyMeter_Geral_Sim21.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM21)
# =============================================================================
# Entradas:
...
#   SIM21: Simulacao 021 segmentos/Curva_de_Carga_GERAL_sim_21.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 021 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM21_2025.csv
# =============================================================================
...
SIM21_DIR = WORK_DIR / "Simulacao 021 segmentos"

META_FP = WORK_DIR / "00_dados_de_entrada_ano_letivo_2025_15min.csv"
SIM2_FP = SIM2_DIR / "Curva_de_Carga_GERAL_sim_2.csv"
SIM21_FP = SIM21_DIR / "Curva_de_Carga_GERAL_sim_21.csv"
OUT_FP = SIM21_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM21_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM21_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM21", sim21, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df21 = meta.merge(sim21, on="k", how="left").rename(columns={"P_3f_S": "P_SIM21", "Q_3f_S": "Q_SIM21"})
...
agg = agg2.merge(agg21, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 021: Tabela de custos (SIM2 vs SIM21 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 021 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM21_2025.csv
#
# Saidas (todas em Simulacao 021 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM21_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM21_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM21_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM21_2025.csv"
OUT_SIM2 = SIM21_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM21 = SIM21_DIR / "Tabela_demanda_consumo_por_posto_SIM21_2025.csv"
OUT_CMP = SIM21_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM21_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM21 = {"DCFP": 4500.0, "DCP": 1400.0}  # 3000 - 2*800
...
tab21 = tabela_custos(df, "SIM21", DCFP=CONTR_SIM21["DCFP"], DCP=CONTR_SIM21["DCP"])
...
print("DONE. Saved (Simulacao 021 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM21)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM21: DCFP=4500, DCP=1400")
print("\nResumo anual:")
print(cmp.tail(1))
