# -*- coding: utf-8 -*-
# =============================================================================
# 021_Script_BESS_Simulacao_020_6bus_0700_2220_2380_1250_1630_1950_duas_simulacoes_conjugado_5000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 020 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 020 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 020 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3250 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 020 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 020 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 020 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 020 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 020 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 020 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 020 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_20.csv
# Remove:
...
#   Simulacao 020 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 020 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim20.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM20 - ANO 2028, 6 BESS 1 MW / 3,25 MWh cada)
# =============================================================================
# Entradas:
...
# Saida:
#   Simulacao 020 segmentos_ano_2028/01_Integralizacao_Mensal_SIM20_2028.csv
#
# Observacao:
...
SIM20_DIR = WORK_DIR / f"Simulacao 020 segmentos_ano_{ANO_ANALISE}"
...
# %% Celula 011 - SIMULACAO 020: tabela de custos (SIM20 - ANO 2028, 6 BESS 1 MW / 3,25 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 020 segmentos_ano_2028/01_Integralizacao_Mensal_SIM20_2028.csv
#
# Saida:
#   Simulacao 020 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM20_2028.csv
#
