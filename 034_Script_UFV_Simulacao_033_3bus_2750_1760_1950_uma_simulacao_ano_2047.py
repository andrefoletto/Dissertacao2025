# -*- coding: utf-8 -*-
# =============================================================================
# 034_Script_UFV_Simulacao_033_3bus_2750_1760_1950_uma_simulacao_ano_2047.py
#
# Regras deste script:
...
DIR_PASS2 = WORK_DIR / "Simulacao 033 segmentos_ano_2047"
...
def _build_circuit_pass2(dss: DSS, posto: str, seg_tag: str) -> dict[str, str]:
    ...
    # 11 strings por inversor -> 220 modulos/inversor -> 99.0 kWpdc por inversor no ano-base
    # Degradacao em 20 anos: 0.995^20 = 0.904610
    # Pmpp degradado por inversor em 2047: 99.0 * 0.995^20 = 89.556 kWpdc
    FATOR_DEGRADACAO_UFV_20_ANOS = 0.995 ** 20
    PMPP_INV_ANO_BASE = 99.0
    PMPP_INV_ANO_2047 = PMPP_INV_ANO_BASE * FATOR_DEGRADACAO_UFV_20_ANOS

    for i in range(1, 9):
        dss.text(
            f"New PVSystem.UFV8001_INV{i} phases=3 bus1=U013 kv=0.38 "
            f"pmpp={PMPP_INV_ANO_2047:.3f} kVA=100 pf=1.0 conn=wye "
...
# =============================================================================
# Entrada:
#   Simulacao 033 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 033 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 033 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 033 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
# Saidas:
#   Simulacao 033 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_33_2047.csv
# Remove:
...
#   Simulacao 033 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 033 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim33_2047.csv
# =============================================================================
...
#   SIM33: Simulacao 033 segmentos_ano_2047/Curva_de_Carga_GERAL_sim_33_2047.csv
#         (Hora_decimal, P_3f_S, Q_3f_S)
#
# Saida:
#   Simulacao 033 segmentos_ano_2047/01_Integralizacao_Mensal_SIM33_2047.csv
#
# OBSERVACAO:
#   - P > 0  -> consumo da rede
#   - P < 0  -> injecao na rede
...
WORK_DIR = Path(r"C:\Users\afole\OneDrive\Dissertacao2025")
SIM33_DIR = WORK_DIR / "Simulacao 033 segmentos_ano_2047"
...
# %% Celula 007 - SIMULACAO 031: Tabela de custos (SIM33 - 2047)
# =============================================================================
# Entrada:
#   Simulacao 033 segmentos_ano_2047/01_Integralizacao_Mensal_SIM33_2047.csv
#
# Saida:
#   Simulacao 033 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM33_2047.csv
#
# HIPOTESE ADOTADA:
...
print("DONE. Saved (Simulacao 033 segmentos_ano_2047):")
print(" -", OUT_SIM33)
