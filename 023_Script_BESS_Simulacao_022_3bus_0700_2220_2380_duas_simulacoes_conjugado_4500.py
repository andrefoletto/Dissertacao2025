# -*- coding: utf-8 -*-
# =============================================================================
# 023_Script_BESS_Simulacao_022_3bus_0700_2220_2380_duas_simulacoes_conjugado_4500.py
#
# Regras deste script:
...
#     Simulacao 022 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 022 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 022 segmentos_pass1_sem_hvac_int"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=4350 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 022 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 022 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 022 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 022 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 022 segmentos/Curva_de_Carga_<KEY>_sim_22.csv
# Remove:
...
#   Simulacao 022 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 022 segmentos/Resumo_EnergyMeter_Geral_Sim22.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM22)
# =============================================================================
# Entradas:
...
#   SIM22: Simulacao 022 segmentos/Curva_de_Carga_GERAL_sim_22.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 022 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM22_2025.csv
# =============================================================================
...
SIM22_DIR = WORK_DIR / "Simulacao 022 segmentos"
...
OUT_FP = SIM22_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM22_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM22_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM22", sim22, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df22 = meta.merge(sim22, on="k", how="left").rename(columns={"P_3f_S": "P_SIM22", "Q_3f_S": "Q_SIM22"})
...
agg = agg2.merge(agg22, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 022: Tabela de custos (SIM2 vs SIM22 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 022 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM22_2025.csv
#
# Saidas (todas em Simulacao 022 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM22_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM22_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM22_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM22_2025.csv"
OUT_SIM2 = SIM22_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM22 = SIM22_DIR / "Tabela_demanda_consumo_por_posto_SIM22_2025.csv"
OUT_CMP = SIM22_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM22_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM22 = {"DCFP": 4500.0, "DCP": 600.0}  # 3000 - 2*400
...
tab22 = tabela_custos(df, "SIM22", DCFP=CONTR_SIM22["DCFP"], DCP=CONTR_SIM22["DCP"])
...
print("DONE. Saved (Simulacao 022 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM22)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM22: DCFP=4500, DCP=600")
print("\nResumo anual:")
print(cmp.tail(1))
