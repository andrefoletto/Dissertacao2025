# -*- coding: utf-8 -*-
# =============================================================================
# 015_Script_BESS_Simulacao_014_6bus_0700_2220_2380_1250_1630_1950_duas_simulacoes.py
#
# Regras deste script:
...
#     Simulacao 014 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 014 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 014 segmentos_pass1_sem_hvac_int"
...
DIR_PASS2 = WORK_DIR / "Simulacao 014 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 014 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 014 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 014 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 014 segmentos/Curva_de_Carga_<KEY>_sim_14.csv
# Remove:
...
#   Simulacao 014 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 014 segmentos/Resumo_EnergyMeter_Geral_Sim14.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM14)
# =============================================================================
# Entradas:
...
#   SIM14: Simulacao 014 segmentos/Curva_de_Carga_GERAL_sim_14.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 014 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM14_2025.csv
# =============================================================================
...
SIM14_DIR = WORK_DIR / "Simulacao 014 segmentos"
...
OUT_FP = SIM14_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM14_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM14_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM14", sim14, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df14 = meta.merge(sim14, on="k", how="left").rename(columns={"P_3f_S": "P_SIM14", "Q_3f_S": "Q_SIM14"})
...
agg = agg2.merge(agg14, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 014: Tabela de custos (SIM2 vs SIM14 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 014 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM14_2025.csv
#
# Saidas (todas em Simulacao 014 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM14_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM14_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM14_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM14_2025.csv"
OUT_SIM2 = SIM14_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM14 = SIM14_DIR / "Tabela_demanda_consumo_por_posto_SIM14_2025.csv"
OUT_CMP = SIM14_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM14_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM14 = {"DCFP": 5000.0, "DCP":   0.0}  # 3000 - 4*000
...
tab14 = tabela_custos(df, "SIM14", DCFP=CONTR_SIM14["DCFP"], DCP=CONTR_SIM14["DCP"])
...
print("DONE. Saved (Simulacao 014 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM14)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM14: DCFP=5000, DCP=0")
print("\nResumo anual:")
print(cmp.tail(1))
