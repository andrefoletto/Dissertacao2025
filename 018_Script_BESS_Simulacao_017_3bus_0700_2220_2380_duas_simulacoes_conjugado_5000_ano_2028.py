# -*- coding: utf-8 -*-
# =============================================================================
# 018_Script_BESS_Simulacao_017_3bus_0700_2220_2380_duas_simulacoes_conjugado_5000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 017 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 017 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 017 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3500 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 017 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 017 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 017 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 017 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 017 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_17.csv
# Remove:
...
#   Simulacao 017 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 017 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim17.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM17 - ANO 2028, 3 BESS 1 MW / 3,5 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM17: curva GERAL com 3 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 017 segmentos_ano_2028/01_Integralizacao_Mensal_SIM17_2028.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 3 BESS do ano 2028 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 017: tabela de custos (SIM17 - ANO 2028, 3 BESS 1 MW / 3,5 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2028/01_Integralizacao_Mensal_SIM17_2028.csv
#
# Saida:
#   Simulacao 017 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM17_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP = 5000 kW * (1 + 3 * 0,5%) = 5075 kW
#   DCP sem BESS = 3000 kW * (1 + 3 * 0,5%) = 3045 kW
#   DCP com 3 BESS = 3045 - (3 x 800) = 645 kW
#
# Observacao:
...
# - Os 3 BESS sao instalados no proprio ano de analise, com potencia operacional total de 2400 kW.
# - Cada banco possui transformador de 1000 kVA, mas opera com kWrated=800 kW e 3500 kWh.
# - Assim, o conjunto reduz a DCP em 3 x 800 = 2400 kW e totaliza 10500 kWh.
...
BESS_E_UNITARIA_KWH = 3500.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 2400 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 10500 kWh

# Separacao operacional da energia:
# - 9000 kWh reservados para load-shift no horario de ponta;
# - 1500 kWh disponiveis para peak-shave fora-ponta.
BESS_E_RESERVA_PONTA_KWH = 9000.0
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)       # 645 kW em 2028
...
print("DONE. Saved (Simulacao 017 - 3 BESS - 2028 - conjugado):")
print(" -", OUT_SIM17)
