# -*- coding: utf-8 -*-
# =============================================================================
# 029_Script_BESS_Simulacao_028_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado_4000_ano_2028_2030_2047.py
#
# Regras deste script:
...
#     Simulacao 028 segmentos_pass1_sem_hvac_int_ano_2030_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 028 segmentos_ano_2030_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 028 segmentos_pass1_sem_hvac_int_ano_2030_2047"
...
#     SOC_15min_BESS_SIM28_2047.csv          (SOC dos quatro bancos a cada 15 min)
#
# Requisitos:
...
BESS_TOTAL_E_2047_KWH = BESS1_E_2047_KWH + BESS2_E_2047_KWH + BESS3_E_2047_KWH + BESS4_E_2047_KWH
...
DIR_PASS2 = WORK_DIR / "Simulacao 028 segmentos_ano_2030_2047"
...
if LIMPAR_SAIDAS_ANTERIORES_PASS2:
    padroes_limpeza = [
        ...
        "SOC_por_segmento.csv",
        "SOC_15min_BESS_SIM28_2047.csv",
        "01_Integralizacao_Mensal_SIM28_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM28_2047.csv",
    ]
    removidos = 0
...
soc_15min_fp = DIR_PASS2 / "SOC_15min_BESS_SIM28_2047.csv"
...
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2030_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 028 segmentos_ano_2030_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2030_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 028 segmentos_ano_2030_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 028 segmentos_ano_2030_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 028 segmentos_ano_2030_2047/Curva_de_Carga_<KEY>_sim_28.csv
# Remove:
...
#   Simulacao 028 segmentos_ano_2030_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 028 segmentos_ano_2030_2047/Resumo_EnergyMeter_Geral_Sim28.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM28 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entradas:
...
#          para o ano 2047.
# Saida:
#   Simulacao 028 segmentos_ano_2030_2047/01_Integralizacao_Mensal_SIM28_2047.csv
#
# Observacao:
...
# Pasta fixa do cenario 2030_2047.
# Nao usar f"Simulacao 028 segmentos_ano_{ANO_ANALISE}", pois ANO_ANALISE=2047
# criaria indevidamente a pasta "Simulacao 028 segmentos_ano_2047".
SIM28_DIR = WORK_DIR / "Simulacao 028 segmentos_ano_2030_2047"
...
# %% Celula 011 - SIMULACAO 028: tabela de custos (SIM28 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entrada:
#   Simulacao 028 segmentos_ano_2030_2047/01_Integralizacao_Mensal_SIM28_2047.csv
#
# Saida:
#   Simulacao 028 segmentos_ano_2030_2047/Tabela_demanda_consumo_por_posto_SIM28_2047.csv
#
...
#   DCP com BESS = 3330 - (673,333 + 673,333 + 673,333 + 686,667) = 623,333 kW
#
...
#     Em 2030: fator 0,841666667 -> 673,333 kW / 5891,7 kWh.
...
# Ponta com BESS: 3330 - (673,333 + 673,333 + 673,333 + 686,667) = 623,333 kW
DCP_SEM_BESS = 3330.0
...
BESS_P_TOTAL_KW = BESS1_P_2047_KW + BESS2_P_2047_KW + BESS3_P_2047_KW + BESS4_P_2047_KW
BESS_E_TOTAL_KWH = BESS1_E_2047_KWH + BESS2_E_2047_KWH + BESS3_E_2047_KWH + BESS4_E_2047_KWH
...
print("DONE. Saved (Simulacao 028 - BESS modular autofinanciado - 2047 - conjugado 4000):")
print(" -", OUT_SIM28)
