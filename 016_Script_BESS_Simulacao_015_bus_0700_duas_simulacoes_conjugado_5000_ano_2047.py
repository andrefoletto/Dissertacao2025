# -*- coding: utf-8 -*-
# =============================================================================
# 016_Script_BESS_Simulacao_015_bus_0700_duas_simulacoes_conjugado_5000_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 015 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 015 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 015 segmentos_pass1_sem_hvac_int_ano_2047"
...
DIR_PASS2 = WORK_DIR / "Simulacao 015 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 015 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 015 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 015 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 015 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 015 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 015 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_15.csv
# Remove:
...
#   Simulacao 015 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 015 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim15.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM15 - ANO 2047, 1 BESS 1 MW / 4,5 MWh instalado em 2028)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM15: curva GERAL com 1 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 015 segmentos_ano_2047/01_Integralizacao_Mensal_SIM15_2047.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao conjugada com 1 BESS do ano 2047 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 015: tabela de custos (SIM15 - ANO 2047, 1 BESS 1 MW / 4,5 MWh instalado em 2028)
# =============================================================================
# Entrada:
#   Simulacao 015 segmentos_ano_2047/01_Integralizacao_Mensal_SIM15_2047.csv
#
# Saida:
#   Simulacao 015 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM15_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP = 5000 kW * (1 + 22 * 0,5%) = 5550 kW
#   DCP sem BESS = 3000 kW * (1 + 22 * 0,5%) = 3330 kW
#   DCP com 1 BESS = 3330 - 673 = 2657 kW
#
# Observacao:
...
# - O BESS foi instalado em 2028 e, em 2047, opera com potencia remanescente de 673 kW.
# - O banco instalado e de 1 MW / 4,5 MWh; em 2047, considera-se capacidade remanescente de 3788 kWh.
DCP_BASE_2025 = 3000.0
DCFP_BASE_2025 = 5000.0
CRESC_LINEAR_ANUAL = 0.005

BESS_P_NOMINAL_KW = 1000.0
BESS_P_OPERACIONAL_KW = 673.0
BESS_E_INSTALADA_2028_KWH = 4500.0
BESS_E_OPERACIONAL_2047_KWH = 3788.0

anos_decorridos = ANO_ANALISE - ANO_BASE_DADOS
fator_linear = 1.0 + CRESC_LINEAR_ANUAL * anos_decorridos

DCP_SEM_BESS = round(DCP_BASE_2025 * fator_linear, 0)        # 3330 kW em 2047
DCFP_COM_BESS = round(DCFP_BASE_2025 * fator_linear, 0)      # 5550 kW em 2047
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_OPERACIONAL_KW) # 2657 kW em 2047
...
print("DONE. Saved (Simulacao 015 - 1 BESS - 2047 - conjugado):")
print(" -", OUT_SIM15)
...
print(f" - Energia instalada do BESS em 2028 = {BESS_E_INSTALADA_2028_KWH:.0f} kWh")
print(f" - Energia operacional remanescente do BESS em 2047 = {BESS_E_OPERACIONAL_2047_KWH:.0f} kWh")
print("\nResumo anual:")
