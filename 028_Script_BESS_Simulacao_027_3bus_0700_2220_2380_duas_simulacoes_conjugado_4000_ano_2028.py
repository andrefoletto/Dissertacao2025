# -*- coding: utf-8 -*-
# =============================================================================
# 028_Script_BESS_Simulacao_027_3bus_0700_2220_2380_duas_simulacoes_conjugado_4000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 027 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 027 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 027 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=7000 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 027 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 027 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 027 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 027 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 027 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 027 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 027 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_27.csv
# Remove:
...
#   Simulacao 027 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 027 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim27.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM27 - ANO 2028, 3 BESS 800 kW / 7,0 MWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM27: curva GERAL com 3 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 027 segmentos_ano_2028/01_Integralizacao_Mensal_SIM27_2028.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 027: tabela de custos (SIM27 - ANO 2028, 3 BESS 800 kW / 7,0 MWh cada)
# =============================================================================
# Entrada:
#   Simulacao 027 segmentos_ano_2028/01_Integralizacao_Mensal_SIM27_2028.csv
#
# Saida:
#   Simulacao 027 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM27_2028.csv
#
...
#
# Banco de energia:
#   3 BESS de 1 MW / 7,0 MWh, operando a 80% da potencia nominal.
#   Potencia operacional total = 2400 kW.
#   Energia total = 21000 kWh.
#   Reserva de ponta = 42,857% = 3/7.
...
# - Cada banco possui 1 MW / 7,0 MWh nominal, mas opera com 800 kW de potencia.
...
DCFP_COM_BESS = 4060.0                                  # corte fora-ponta: 4000 * 1,015
...
print("DONE. Saved (Simulacao 027 - 3 BESS - 2028 - 21 MWh - alvo FP 4060/3553):")
print(" -", OUT_SIM27)
