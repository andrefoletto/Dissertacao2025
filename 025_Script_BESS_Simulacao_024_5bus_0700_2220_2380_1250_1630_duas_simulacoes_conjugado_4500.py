# -*- coding: utf-8 -*-
# =============================================================================
# 025_Script_BESS_Simulacao_024_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_4500.py
#
# Regras deste script:
...
#     Simulacao 024 segmentos_pass1_sem_hvac_int
#   PASSO 2 (simulacao completa final):
#     Simulacao 024 segmentos
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 024 segmentos_pass1_sem_hvac_int"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3800 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 024 segmentos"
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 024 segmentos/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 024 segmentos/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 024 segmentos/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 024 segmentos/Curva_de_Carga_<KEY>_sim_24.csv
# Remove:
...
#   Simulacao 024 segmentos/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 024 segmentos/Resumo_EnergyMeter_Geral_Sim24.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM2 vs SIM24)
# =============================================================================
# Entradas:
...
#   SIM24: Simulacao 024 segmentos/Curva_de_Carga_GERAL_sim_24.csv (Hora_decimal, P_3f_S, Q_3f_S)
# Saida:
#   Simulacao 024 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM24_2025.csv
# =============================================================================
...
SIM24_DIR = WORK_DIR / "Simulacao 024 segmentos"
...
OUT_FP = SIM24_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM24_2025.csv"
...
for fp in [META_FP, SIM2_FP, SIM24_FP]:
    if not fp.exists():
...
for name, dfx, req in [
    ...
    ("SIM24", sim24, ["Hora_decimal", "P_3f_S", "Q_3f_S"]),
]:
...
df24 = meta.merge(sim24, on="k", how="left").rename(columns={"P_3f_S": "P_SIM24", "Q_3f_S": "Q_SIM24"})
...
agg = agg2.merge(agg24, on=group_cols, how="outer")
...
# %% Celula 011 - SIMULACAO 024: Tabela de custos (SIM2 vs SIM24 - 2025) com demandas contratadas diferentes
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos/01_Integralizacao_Mensal_SIM2_x_SIM24_2025.csv
#
# Saidas (todas em Simulacao 024 segmentos):
#   Tabela_demanda_consumo_por_posto_SIM2_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM24_2025.csv
#   Tabela_demanda_consumo_por_posto_SIM2_vs_SIM24_2025.csv   (economia)
# =============================================================================
...
IN_FP = SIM24_DIR / "01_Integralizacao_Mensal_SIM2_x_SIM24_2025.csv"
OUT_SIM2 = SIM24_DIR / "Tabela_demanda_consumo_por_posto_SIM2_2025.csv"
OUT_SIM24 = SIM24_DIR / "Tabela_demanda_consumo_por_posto_SIM24_2025.csv"
OUT_CMP = SIM24_DIR / "Tabela_demanda_consumo_por_posto_SIM2_vs_SIM24_2025.csv"

CONTR_SIM2 = {"DCFP": 5000.0, "DCP": 3000.0}
CONTR_SIM24 = {"DCFP": 4500.0, "DCP":   0.0}  # 3000 - 4*000
...
tab24 = tabela_custos(df, "SIM24", DCFP=CONTR_SIM24["DCFP"], DCP=CONTR_SIM24["DCP"])
...
print("DONE. Saved (Simulacao 024 segmentos):")
print(" -", OUT_SIM2)
print(" -", OUT_SIM24)
print(" -", OUT_CMP)
print("\nDemandas contratadas usadas:")
print(" - SIM2: DCFP=5000, DCP=3000")
print(" - SIM24: DCFP=4500, DCP=0")
print("\nResumo anual:")
print(cmp.tail(1))
