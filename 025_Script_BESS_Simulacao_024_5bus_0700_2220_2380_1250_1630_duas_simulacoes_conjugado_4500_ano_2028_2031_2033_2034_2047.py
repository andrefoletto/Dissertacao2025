# -*- coding: utf-8 -*-
# =============================================================================
# 025_Script_BESS_Simulacao_024_5bus_0700_2220_2380_1250_1630_duas_simulacoes_conjugado_4500_ano_2028_2031_2033_2034_2047.py
#
# Regras deste script:
...
#     Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2034_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 024 segmentos_ano_2034_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 024 segmentos_pass1_sem_hvac_int_ano_2034_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=4629.167 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
    ...
    dss.text(
        ...
        f"kWrated=693 kWhrated=2600 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
    ...
    dss.text(
        ...
        f"kWrated=713 kWhrated=2675 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
#     SOC_15min_BESS_SIM24_2047.csv          (SOC dos cinco bancos a cada 15 min)
#
# Requisitos:
...
BESS1_E_2047_KWH = 4629.167
BESS2_E_2047_KWH = 4629.167
BESS3_E_2047_KWH = 2600.0
BESS4_E_2047_KWH = 2650.0
BESS5_E_2047_KWH = 2675.0
...
DIR_PASS2 = WORK_DIR / "Simulacao 024 segmentos_ano_2034_2047"
...
if LIMPAR_SAIDAS_ANTERIORES_PASS2:
    padroes_limpeza = [
        ...
        "SOC_por_segmento.csv",
        "SOC_15min_BESS_SIM24_2047.csv",
        "01_Integralizacao_Mensal_SIM24_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM24_2047.csv",
    ]
    removidos = 0
...
soc_15min_fp = DIR_PASS2 / "SOC_15min_BESS_SIM24_2047.csv"
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2034_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2034_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2034_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 024 segmentos_ano_2034_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 024 segmentos_ano_2034_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 024 segmentos_ano_2034_2047/Curva_de_Carga_<KEY>_sim_24.csv
# Remove:
...
#   Simulacao 024 segmentos_ano_2034_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 024 segmentos_ano_2034_2047/Resumo_EnergyMeter_Geral_Sim24.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM24 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entradas:
...
#          para o ano 2033.
# Saida:
#   Simulacao 024 segmentos_ano_2034_2047/01_Integralizacao_Mensal_SIM24_2047.csv
#
# Observacao:
...
#     BESS5: instalado em 2033, 1 MW / 3,0 MWh, operando a 80% da potencia,
#            sem degradacao: 800 kW / 3000 kWh.
...
SIM24_DIR = WORK_DIR / "Simulacao 024 segmentos_ano_2034_2047"
...
# %% Celula 011 - SIMULACAO 019: tabela de custos (SIM24 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entrada:
#   Simulacao 024 segmentos_ano_2034_2047/01_Integralizacao_Mensal_SIM24_2047.csv
#
# Saida:
#   Simulacao 024 segmentos_ano_2034_2047/Tabela_demanda_consumo_por_posto_SIM24_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP contratada com BESS = 4500 * 1,11 = 4995 kW
#   Alvo operacional fora-ponta do despacho = 4995 kW
#   Permissao para recarga fora-ponta = 3500 * 1,11 = 3885 kW
#   DCP sem BESS = 3000 * 1,11 = 3330 kW
#   DCP com BESS = max(0, 3120 - (767 + 767 + 787 + 800 + 800)) = 0 kW
#
...
#     Em 2047: fator 0,841666667 -> 673 kW / 4629,2 kWh.
...
# -------------------------
# Fora-ponta: 4500 * 1,11 = 4995 kW
# Ponta sem BESS: 3000 * 1,11 = 3330 kW
# Ponta com BESS: max(0, 3330 - (673 + 673 + 693 + 707 + 713)) = 0 kW
DCP_SEM_BESS = 3330.0
...
BESS3_FATOR_DEGRADACAO_2047 = 0.8666666666666667
...
BESS4_FATOR_DEGRADACAO_2047 = 0.8833333333333333
BESS4_P_2047_KW = round(BESS4_P_OPERACIONAL_2033_KW * BESS4_FATOR_DEGRADACAO_2047)
...
BESS5_FATOR_DEGRADACAO_2047 = 0.8916666666666667
BESS5_P_2047_KW = round(BESS5_P_OPERACIONAL_2034_KW * BESS5_FATOR_DEGRADACAO_2047)
...
print("DONE. Saved (Simulacao 024 - BESS modular autofinanciado - 2047 - conjugado):")
print(" -", OUT_SIM24)
