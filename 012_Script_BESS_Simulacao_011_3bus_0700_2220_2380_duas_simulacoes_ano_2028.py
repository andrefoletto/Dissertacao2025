# -*- coding: utf-8 -*-
# =============================================================================
# 012_Script_BESS_Simulacao_011_3bus_0700_2220_2380_duas_simulacoes_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 011 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 011 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 011 segmentos_pass1_sem_hvac_int_ano_2028"
...
DIR_PASS2 = WORK_DIR / "Simulacao 011 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 011 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 011 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 011 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 011 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_11.csv
# Remove:
...
#   Simulacao 011 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 011 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim11.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM11 - ANO 2028, 3 BESS)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM11: curva GERAL com 3 BESS para o ano 2028
# Saida:
#   Simulacao 011 segmentos_ano_2028/01_Integralizacao_Mensal_SIM11_2028.csv
#
# Observacao:
#   Esta celula nao compara com SIM2/RGE nem com outra simulacao.
#   Ela apenas integraliza a simulacao com 3 BESS do ano 2028 por mes e posto.
# =============================================================================
...
# %% Celula 011 - SIMULACAO 011: tabela de custos (SIM11 - ANO 2028, 3 BESS)
# =============================================================================
# Entrada:
#   Simulacao 011 segmentos_ano_2028/01_Integralizacao_Mensal_SIM11_2028.csv
#
# Saida:
#   Simulacao 011 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM11_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP = 5000 kW * (1 + 3 * 0,5%) = 5075 kW
#   DCP sem BESS = 3000 kW * (1 + 3 * 0,5%) = 3045 kW
#   DCP com 3 BESS = 3045 - 3 * 800 = 645 kW
#
# Observacao:
...
# - A demanda contratada de ponta com 3 BESS considera abatimento de 3 x 800 kW.
...
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - NUM_BESS * BESS_P_KW) # 645 kW em 2028
