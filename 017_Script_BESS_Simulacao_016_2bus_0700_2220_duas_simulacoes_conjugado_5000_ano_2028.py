# -*- coding: utf-8 -*-
# =============================================================================
# 017_Script_BESS_Simulacao_016_2bus_0700_2220_duas_simulacoes_conjugado_5000_ano_2028.py
#
# Regras deste script:
...
#     Simulacao 016 segmentos_pass1_sem_hvac_int_ano_2028
#   PASSO 2 (simulacao completa final):
#     Simulacao 016 segmentos_ano_2028
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 016 segmentos_pass1_sem_hvac_int_ano_2028"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=800 kWhrated=3750 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 016 segmentos_ano_2028"
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2028/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 016 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2028/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 016 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 016 segmentos_ano_2028/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 016 segmentos_ano_2028/Curva_de_Carga_<KEY>_sim_16.csv
# Remove:
...
#   Simulacao 016 segmentos_ano_2028/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 016 segmentos_ano_2028/Resumo_EnergyMeter_Geral_Sim16.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM16 - ANO 2028, 2 BESS 800 kW / 3750 kWh cada)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM16: curva GERAL com 2 BESS em operacao conjugada para o ano 2028
# Saida:
#   Simulacao 016 segmentos_ano_2028/01_Integralizacao_Mensal_SIM16_2028.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 015: tabela de custos (SIM16 - ANO 2028, 2 BESS 800 kW / 3750 kWh cada)
# =============================================================================
# Entrada:
#   Simulacao 016 segmentos_ano_2028/01_Integralizacao_Mensal_SIM16_2028.csv
#
# Saida:
#   Simulacao 016 segmentos_ano_2028/Tabela_demanda_consumo_por_posto_SIM16_2028.csv
#
# Demandas contratadas do ano 2028:
#   DCFP = 5000 kW * (1 + 3 * 0,5%) = 5075 kW
#   DCP sem BESS = 3000 kW * (1 + 3 * 0,5%) = 3045 kW
#   DCP com 2 BESS = 3045 - 1600 = 1445 kW
#
# Observacao:
...
# - Os 2 BESS sao instalados no proprio ano de analise, com potencia operacional total de 1600 kW.
# - Cada banco considerado possui 800 kW / 3750 kWh; o conjunto totaliza 1600 kW / 7500 kWh.
DCP_BASE_2025 = 3000.0
DCFP_BASE_2025 = 5000.0
CRESC_LINEAR_ANUAL = 0.005

NUM_BESS = 2
BESS_P_UNITARIA_KW = 800.0
BESS_E_UNITARIA_KWH = 3750.0

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW       # 1600 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH     # 7500 kWh

# Separacao operacional da energia:
# - 6000 kWh reservados para load-shift no horario de ponta;
# - 1500 kWh disponiveis para peak-shave fora-ponta.
BESS_E_RESERVA_PONTA_KWH = 6000.0
...
print("DONE. Saved (Simulacao 016 - 2 BESS - 2028 - conjugado):")
print(" -", OUT_SIM16)
