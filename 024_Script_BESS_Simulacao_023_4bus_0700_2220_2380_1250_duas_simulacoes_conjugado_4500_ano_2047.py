# -*- coding: utf-8 -*-
# =============================================================================
# 024_Script_BESS_Simulacao_023_4bus_0700_2220_2380_1250_duas_simulacoes_conjugado_4500_ano_2047.py
#
# Regras deste script:
...
#     Simulacao 023 segmentos_pass1_sem_hvac_int_ano_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 023 segmentos_ano_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 023 segmentos_pass1_sem_hvac_int_ano_2047"
...
def build_circuit_pass1(
    ...
    dss.text(
        ...
        f"kWrated=673 kWhrated=3577 Effcurve=Eff %EffCharge=95 %EffDischarge=95 "
...
DIR_PASS2 = WORK_DIR / "Simulacao 023 segmentos_ano_2047"
...
# =============================================================================
# Entrada:
#   Simulacao 023 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 023 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 023 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 023 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 023 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 023 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_23.csv
# Remove:
...
#   Simulacao 023 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 023 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim23.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM23 - ANO 2047, 4 BESS degradados)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         Usado apenas como mapa anual de Hora_decimal, Mes e Posto.
#   SIM23: curva GERAL com 4 BESS em operacao conjugada para o ano 2047
# Saida:
#   Simulacao 023 segmentos_ano_2047/01_Integralizacao_Mensal_SIM23_2047.csv
#
# Observacao:
...
# %% Celula 011 - SIMULACAO 023: tabela de custos (SIM23 - ANO 2047, 4 BESS degradados)
# =============================================================================
# Entrada:
#   Simulacao 023 segmentos_ano_2047/01_Integralizacao_Mensal_SIM23_2047.csv
#
# Saida:
#   Simulacao 023 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM23_2047.csv
#
# Demandas contratadas do ano 2047:
#   DCFP com BESS = 4995 kW  (corte fora-ponta agressivo)
#   DCP sem BESS = 3330 kW
#   DCP com 4 BESS = 3330 - (4 * 673) = 638 kW
#
# Banco de energia:
#   4 BESS de 1 MW / 4,25 MWh instalados em 2028.
#   Operacao nova a 80% da potencia nominal: 800 kW por banco.
#   Em 2047, considera-se SOH = 84,1666667%.
#   Potencia operacional degradada por banco = 673 kW.
#   Energia degradada adotada por banco = 3577 kWh.
...
# -------------------------
# Premissas:
# - BESS instalados em 2028 e avaliados em 2047.
# - Cada banco possui 1 MW / 4,25 MWh nominal.
# - A potencia operacional nova e 80% da potencia nominal: 800 kW por banco.
# - Em 2047, usa-se SOH = 84,1666667%.
# - A potencia considerada para reducao da DCP e 673 kW por banco.
# - A energia degradada adotada no OpenDSS e 3577 kWh por banco.
# - A demanda contratada fora-ponta foi reduzida de forma agressiva para 4995 kW.
NUM_BESS = 4

BESS_P_NOMINAL_UNITARIA_KW = 1000.0
BESS_FATOR_OPERACAO_P = 0.80
BESS_SOH_2047 = 0.8416666666666667

BESS_P_NOVA_OPERACIONAL_KW = BESS_P_NOMINAL_UNITARIA_KW * BESS_FATOR_OPERACAO_P
BESS_P_UNITARIA_KW = 673.0
BESS_E_NOMINAL_UNITARIA_KWH = 4250.0
BESS_E_UNITARIA_KWH = 3577.0
BESS_RESERVA_PONTA_PCT = 70.6

BESS_P_TOTAL_KW = NUM_BESS * BESS_P_UNITARIA_KW                 # 2692 kW
BESS_E_TOTAL_KWH = NUM_BESS * BESS_E_UNITARIA_KWH               # 14308 kWh
...
DCP_SEM_BESS = 3330.0
DCP_COM_BESS = max(0.0, DCP_SEM_BESS - BESS_P_TOTAL_KW)         # 638 kW
...
print("DONE. Saved (Simulacao 023 - 4 BESS - 2047 - conjugado 4500):")
print(" -", OUT_SIM23)
...
print(f" - SOH em 2047 = {BESS_SOH_2047 * 100:.4f}%")
