# -*- coding: utf-8 -*-
# =============================================================================
# 032_Script_UFV_Simulacao_031_1bus_2750_uma_simulacao_ano_2047.py
#
# Regras deste script:
...
# ======================================================================================
# Saidas:
#   Simulacao 031 segmentos_ano_2047/
...
DIR_PASS2 = WORK_DIR / "Simulacao 031 segmentos_ano_2047"
...
if LIMPAR_SAIDAS_ANTERIORES:
    padroes_limpeza = [
        "UFSM_Mon_*_s*.csv",
        "Monitor_*_anual.csv",
        "Curva_de_Carga_*_sim_31_2047.csv",
        "Curva_de_Carga_*_sim_31.csv",
        "EXP_MTR_GERAL*.csv",
        "Resumo_EnergyMeter_Geral_Sim31_2047.csv",
        "01_Integralizacao_Mensal_SIM31_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM31_2047.csv",
    ]
    removidos = 0
    for padrao in padroes_limpeza:
        for fp in DIR_PASS2.glob(padrao):
            if fp.is_file():
                fp.unlink()
                removidos += 1
    print(f"[CLEAN] SIM31 2047: {removidos} arquivo(s) antigo(s) removido(s) em {DIR_PASS2}")
...
# =============================================================================
# Entrada:
#   Simulacao 031 segmentos_ano_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 031 segmentos_ano_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 031 segmentos_ano_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 031 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
# Saidas:
#   Simulacao 031 segmentos_ano_2047/Curva_de_Carga_<KEY>_sim_31_2047.csv
# Remove:
...
for in_fp in files:
    ...
    out_fp = DIR_PASS2 / f"Curva_de_Carga_{mon_key}_sim_31_2047.csv"
...
#   Simulacao 031 segmentos_ano_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 031 segmentos_ano_2047/Resumo_EnergyMeter_Geral_Sim31_2047.csv
# =============================================================================
...
OUT_FP = DIR_PASS2 / "Resumo_EnergyMeter_Geral_Sim31_2047.csv"
...
# %% Celula 006 - ENERGIA e DEMANDA MAX por mes e posto (SIM31 - 2047)
# =============================================================================
# Entradas:
#   META: 00_dados_de_entrada_ano_letivo_2025_15min.csv
#         (Hora_decimal, Mes, Posto)
#   SIM31: Simulacao 031 segmentos_ano_2047/Curva_de_Carga_GERAL_sim_31_2047.csv
#         (Hora_decimal, P_3f_S, Q_3f_S)
#
# Saida:
#   Simulacao 031 segmentos_ano_2047/01_Integralizacao_Mensal_SIM31_2047.csv
#
# OBSERVACAO:
#   - P > 0  -> consumo da rede
#   - P < 0  -> injecao na rede
...
WORK_DIR = Path(r"C:\Users\afole\OneDrive\Dissertacao2025")
SIM31_DIR = WORK_DIR / "Simulacao 031 segmentos_ano_2047"

META_FP = WORK_DIR / "00_dados_de_entrada_ano_letivo_2025_15min.csv"
SIM31_FP = SIM31_DIR / "Curva_de_Carga_GERAL_sim_31_2047.csv"
OUT_FP = SIM31_DIR / "01_Integralizacao_Mensal_SIM31_2047.csv"
...
# %% Celula 007 - SIMULACAO 031: Tabela de custos (SIM31 - 2047)
# =============================================================================
# Entrada:
#   Simulacao 031 segmentos_ano_2047/01_Integralizacao_Mensal_SIM31_2047.csv
#
# Saida:
#   Simulacao 031 segmentos_ano_2047/Tabela_demanda_consumo_por_posto_SIM31_2047.csv
#
# HIPOTESE ADOTADA:
...
IN_FP = SIM31_DIR / "01_Integralizacao_Mensal_SIM31_2047.csv"
OUT_SIM31 = SIM31_DIR / "Tabela_demanda_consumo_por_posto_SIM31_2047.csv"

# -------------------------
# DEMANDAS CONTRATADAS
# -------------------------
CONTR_SIM31 = {"DCFP": 5550.0, "DCP": 3330.0}
...
print("DONE. Saved (Simulacao 031 segmentos_ano_2047):")
print(" -", OUT_SIM31)

print("\nDemandas contratadas usadas:")
print(" - SIM31: DCFP=5550 kW, DCP=3330 kW")
