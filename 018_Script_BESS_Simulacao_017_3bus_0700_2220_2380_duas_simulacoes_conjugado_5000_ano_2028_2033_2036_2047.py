# -*- coding: utf-8 -*-
# =============================================================================
# 018_Script_BESS_Simulacao_017_3bus_0700_2220_2380_duas_simulacoes_conjugado_5000_ano_2028_2033_2036_2047.py
#
# Regras deste script:
...
#     Simulacao 017 segmentos_pass1_sem_hvac_int_ano_2036_2047
#   PASSO 2 (simulacao completa final):
#     Simulacao 017 segmentos_ano_2036_2047
# =============================================================================
...
DIR_PASS1 = WORK_DIR / "Simulacao 017 segmentos_pass1_sem_hvac_int_ano_2036_2047"
...
#     SOC_15min_BESS_SIM17_2047.csv          (SOC dos tres bancos a cada 15 min)
#
# Requisitos:
...
DIR_PASS2 = WORK_DIR / "Simulacao 017 segmentos_ano_2036_2047"
...
if LIMPAR_SAIDAS_ANTERIORES_PASS2:
    padroes_limpeza = [
        ...
        "SOC_por_segmento.csv",
        "SOC_15min_BESS_SIM17_2047.csv",
        "01_Integralizacao_Mensal_SIM17_2047.csv",
        "Tabela_demanda_consumo_por_posto_SIM17_2047.csv",
    ]
    removidos = 0
...
soc_15min_fp = DIR_PASS2 / "SOC_15min_BESS_SIM17_2047.csv"
...
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2036_2047/UFSM_Mon_<KEY>_s*.csv
# Saida:
#   Simulacao 017 segmentos_ano_2036_2047/Monitor_<KEY>_anual.csv
# Remove:
...
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2036_2047/EXP_MTR_GERAL_*.csv
# Saida:
#   Simulacao 017 segmentos_ano_2036_2047/EXP_MTR_GERAL_anual.csv
# Remove:
#   EXP_MTR_GERAL_*.csv
# =============================================================================
...
#   Simulacao 017 segmentos_ano_2036_2047/Monitor_<KEY>_anual.csv
# Saidas:
#   Simulacao 017 segmentos_ano_2036_2047/Curva_de_Carga_<KEY>_sim_17.csv
# Remove:
...
#   Simulacao 017 segmentos_ano_2036_2047/EXP_MTR_GERAL_anual.csv
# Saida:
#   Simulacao 017 segmentos_ano_2036_2047/Resumo_EnergyMeter_Geral_Sim17.csv
# =============================================================================
...
# %% Celula 010 - ENERGIA e DEMANDA MAX por mes e posto (SIM17 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entradas:
...
#          para o ano 2047.
# Saida:
#   Simulacao 017 segmentos_ano_2036_2047/01_Integralizacao_Mensal_SIM17_2047.csv
#
# Observacao:
...
SIM17_DIR = WORK_DIR / "Simulacao 017 segmentos_ano_2036_2047"
...
# %% Celula 011 - SIMULACAO 017: tabela de custos (SIM17 - ANO 2047, BESS modular autofinanciado)
# =============================================================================
# Entrada:
#   Simulacao 017 segmentos_ano_2036_2047/01_Integralizacao_Mensal_SIM17_2047.csv
#
# Saida:
#   Simulacao 017 segmentos_ano_2036_2047/Tabela_demanda_consumo_por_posto_SIM17_2047.csv
#
...
#   DCP com BESS = 3330 - (673 + 707 + 727) = 1223 kW
#
...
#     1 MW / 3,0 MWh nominal, operando a 80% da potencia nominal, degradado em 2047 por fator 0,908333333 -> 727 kW / 2725 kWh.
...
# Ponta com BESS: 3330 - (673 + 707 + 727) = 1223 kW
DCP_SEM_BESS = 3330.0
...
BESS3_P_OPERACIONAL_INSTALACAO_KW = 800.0
BESS3_E_NOMINAL_KWH = 3000.0
BESS3_FATOR_DEGRADACAO_2047 = 0.908333333
BESS3_P_2047_KW = round(BESS3_P_OPERACIONAL_INSTALACAO_KW * BESS3_FATOR_DEGRADACAO_2047)
...
print("DONE. Saved (Simulacao 017 - BESS modular autofinanciado - 2047 - conjugado):")
print(" -", OUT_SIM17)
